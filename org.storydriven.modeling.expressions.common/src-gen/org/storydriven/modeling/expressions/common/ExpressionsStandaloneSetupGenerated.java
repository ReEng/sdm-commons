...
public class ExpressionsStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.storydriven.modeling.expressions.common.ExpressionsRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.storydriven.org/modeling/expressions/common/Expressions")) {
		EPackage.Registry.INSTANCE.put("http://www.storydriven.org/modeling/expressions/common/Expressions", org.storydriven.modeling.expressions.common.expressions.ExpressionsPackage.eINSTANCE);
	}
