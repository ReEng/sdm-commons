...
\todoch{ Meiner Meinung nach gehoeren die nachfolgenden beiden Absaetze hier nicht hin! Entweder eigene Section zu Model Transformations und DSLs in den Foundations oder in die Nutshell integrieren}
...
The \fe{Petrinet} consists of \fe{Nodes} and \fe{Arcs}.
...
\todoch{Dieser Absatz sollte auch nicht hier stehen.}
