...
\todomvd{Extend example to contain advanced concepts presented in v0.2.}
...
\todomvd{OCL constraints in story node 1 correct? Is interface the correct context? Can I use method.named to reference the SDs parameter?}
...
\todomvd{OCL attribute constraint in story node 1 correct?}
