...
one can, for example, collect a set of \fe{Method} objects in a set \fe{methods} as illustrated in the first story node in Figure~\ref{fig:InclusionLinksExample1}
