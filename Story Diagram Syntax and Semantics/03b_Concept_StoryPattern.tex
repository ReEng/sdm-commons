...
\begin{table}[htbp]
  ...
  \caption{Inclusion Links Between Two Object Set Variables}
    ...
    Ordered Set & Bag / Set & CHECK\_ONLY & Each element in B is contained (once) in A. \\
    Ordered Set & Ordered Set / List & CHECK\_ONLY & Each element in B is contained (once) in A (and has the same order?). \\
    List & Bag & CHECK\_ONLY & \\
    List & Set & CHECK\_ONLY & \\
    List & Ordered Set & CHECK\_ONLY & \\
    List & List & CHECK\_ONLY & \\
    \hline
    \end{tabular}%
