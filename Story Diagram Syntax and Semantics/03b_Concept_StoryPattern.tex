...
If an object contained in \fe{b} is contained more than once in \fe{a}, we remove all of its occurrences in \fe{a}.
This comes close to the mathematical relative complement operation (mathematically $a \setminus b$).
If both, \fe{a} and \fe{b} are lists, we only remove as many occurrences of the objects in \fe{b} from \fe{a} as these are available in \fe{b}.
...
\tododt{Move this section about link constraints in combination with inclusion links to Section~\ref{sec:StoryPatterns:linkConstraints}?}
