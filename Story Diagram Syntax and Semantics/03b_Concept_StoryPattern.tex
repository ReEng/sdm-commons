...
explain semantics of containment for all combinations (ordered set, list) in Table~\ref{tab:set_operations_with_inclusion_links};
all combinations of adding/removing a collection to/from another collection (ordered set, list)
