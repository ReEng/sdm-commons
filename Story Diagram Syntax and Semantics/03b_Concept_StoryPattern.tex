...
must contain at least one bound object variable. This is necessary to avoid a search over the whole underlying object model which probably requires a long runtime.
...
negative can be matched during the execution of the story pattern, the pattern fails, too.
