...
\providecommand{\destroy}[1][\xspace]{{\small{ \texttt{\flqq destroy\frqq}}}#1}
\providecommand{\create}[1][\xspace]{\small{\texttt{\flqq create\frqq}}#1}
...
% 	\newpage
	...
	\begin{itemize}
		\item Wir schreiben American English.
		\item Zur Hervorhebung von Bildelementen wird der (selbstdefinierte) Befehl \begin{verbatim}\fe{arg}\end{verbatim} verwendet.
		\item F\"ur die W\"orter \create, \destroy und \fuj gibt es die Kommandos \verb+\create+, \verb+\destroy+ und \verb+\fuj+.
