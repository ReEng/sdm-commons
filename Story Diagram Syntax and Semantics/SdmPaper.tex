...
\hypersetup{%
pdfauthor={Markus von Detten, Christian Heinzemann, Dietrich Travkin, and many more}
...
\begin{document}                     % und los!
	...
	{\center
			...
			\todoall{Kill the left margin to center the page.}
			\vspace{1.5cm}
			...
			%f"ur den Masterstudiengang \\ Informatik \\ \vspace{1cm}
			
			~\\ % Jannis Drewello, |$drewello$
			{Markus von Detten, Christian Heinzemann, Dietrich Travkin, and many more} \\%[0.2cm]
