\documentclass[12pt,a4paper,twoside,titlepage,openright,headsepline,listof=totoc,index=totoc,chapterprefix,bibliography=totoc,noenddot,%
...
%% snake-oil fï¿½r den Satz
 \pretolerance=100           %% Textsatz: interner Parameter zur Steuerung des Zeilenumbruchs \tolerance 300              %% 1414 Bewertungsgrenzwert fï¿½r schlecht umbrochene Zeilen
 \hfuzz=0.2pt                %% Grenze, ab der eine overfull hbox gemeldet wird
 \vfuzz=0.2pt                %% Grenzwert, ab dem die ï¿½berfï¿½llung einer \vbox protokolliert wird
 \hbadness 1414              %% Grenzwert fï¿½r ï¿½schlechteï¿½ Zeilen, bzw. Boxen
 \vbadness	1000              %% Grenzwert fï¿½r eine ï¿½schlechteï¿½ \vbox 
 \emergencystretch 1em       %% zusï¿½tzlicher dynamischer Leerraum
 \hyphenpenalty=30           %% Strafpunkte bei Silbentrennung ï¿½ber Absatz hinweg
...
% 	\newpage
	...
	\input{03_Concepts.tex}
	
	\input{04_CompleteExample.tex}	

	\input{06_RelatedWork.tex}
...
%\ext
{
	\input{08a_User_Guide.tex}
}

	\input{08b_Execution.tex}
