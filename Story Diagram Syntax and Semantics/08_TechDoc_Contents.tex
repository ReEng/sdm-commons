...
\input{figures/A_technical-reference/packages/core/graphics}
...
\input{figures/A_technical-reference/packages/core_expressions/graphics}
...
\input{figures/A_technical-reference/packages/core_expressions_common/graphics}
...
\input{figures/A_technical-reference/packages/storydiagrams/graphics}
...
\input{figures/A_technical-reference/packages/storydiagrams_activities/graphics}
...
\input{figures/A_technical-reference/packages/storydiagrams_activities_expressions/graphics}
...
\input{figures/A_technical-reference/packages/storydiagrams_calls/graphics}
...
\input{figures/A_technical-reference/packages/storydiagrams_calls_expressions/graphics}
...
\input{figures/A_technical-reference/packages/storydiagrams_patterns/graphics}
...
\input{figures/A_technical-reference/packages/storydiagrams_patterns_expressions/graphics}
...
\input{figures/A_technical-reference/packages/storydiagrams_templates/graphics}
