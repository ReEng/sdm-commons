...
In contrast to QVT \cite{QVT}, we do not allow in-out parameters. An object that is passed to a story diagram as an in parameter may not be returned as an out parameter.
