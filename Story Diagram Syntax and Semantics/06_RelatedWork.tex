...
\emph{Groove}~\cite{Ren04a} \todomvd{Passt die Referenz? Hab die einfach mal aus dem Aigaion gefischt.} is a graph transformation tool with a focus on analyzing graph transformation systems.
