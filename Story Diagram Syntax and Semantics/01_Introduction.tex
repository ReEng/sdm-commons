...
% Problem Area
The high complexity of modern technical systems poses great challenges to the development process of such systems.
Model-based development approaches are a promising means to tackle this complexity.
In such a model-based development approach, models are considered first-class artifacts of the development.
...
% Problem
Since their introduction in 1998, story diagrams have been successfully applied in a wide range of application scenarios and are used for diverse purposes.
Furthermore, several extensions to story diagrams have been proposed.
For instance, Story Decision Diagrams (SDDs) \cite{GK06a} extend story diagrams with features of logics such as quantification to allow expressing complex properties like safety requirements.
Timed Story Scenario Diagrams (TSSD) \cite{KG07a} are a story-diagram-based notation for the specification of scenarios, integrating structural and temporal aspects.
