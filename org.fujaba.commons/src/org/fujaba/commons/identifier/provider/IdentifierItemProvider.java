 ...
 * $Id$
 */
package org.fujaba.commons.identifier.provider;
...
/**
 * This is the item provider adapter for a {@link org.fujaba.commons.identifier.Identifier} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
      ...
      IItemPropertySource
{
   ...
   protected void addNamePropertyDescriptor(Object object)
   {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_Identifier_name_feature"), //$NON-NLS-1$
             getString("_UI_PropertyDescriptor_description", "_UI_Identifier_name_feature", "_UI_Identifier_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
   ...
   public String getText(Object object)
   {
      ...
      return label == null || label.length() == 0 ?
         getString("_UI_Identifier_type") : //$NON-NLS-1$
         getString("_UI_Identifier_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
   }
   ...
   public void notifyChanged(Notification notification)
   {
      ...
      switch (notification.getFeatureID(Identifier.class))
      {
         ...
         case IdentifierPackage.IDENTIFIER__NAME:
            ...
            return;
         case IdentifierPackage.IDENTIFIER__EANNOTATIONS:
