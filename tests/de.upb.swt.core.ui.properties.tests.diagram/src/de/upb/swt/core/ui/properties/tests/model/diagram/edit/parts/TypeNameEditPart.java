...
import de.upb.swt.core.ui.properties.tests.model.diagram.edit.policies.ModelTextSelectionEditPolicy;
...
public class TypeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new ContainerEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider
					.getParser(
							ModelElementTypes.Type_2001,
							getParserElement(),
							ModelVisualIDRegistry
									.getType(de.upb.swt.core.ui.properties.tests.model.diagram.edit.parts.TypeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null, ModelEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
