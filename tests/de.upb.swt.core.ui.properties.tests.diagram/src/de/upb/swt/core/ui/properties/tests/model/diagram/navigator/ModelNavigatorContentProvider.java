...
import de.upb.swt.core.ui.properties.tests.model.diagram.part.Messages;
...
public class ModelNavigatorContentProvider implements ICommonContentProvider {
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case TypeEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(Collections.singleton(sv),
					ModelVisualIDRegistry.getType(BooleanAttributeEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					ModelVisualIDRegistry.getType(ReferenceEditPart.VISUAL_ID));
		...
		case ContainerEditPart.VISUAL_ID: {
			...
			ModelNavigatorGroup links = new ModelNavigatorGroup(Messages.NavigatorGroupName_Container_1000_links,
		...
		case ReferenceEditPart.VISUAL_ID: {
			LinkedList<ModelAbstractNavigatorItem> result = new LinkedList<ModelAbstractNavigatorItem>();
			Edge sv = (Edge) view;
			ModelNavigatorGroup target = new ModelNavigatorGroup(Messages.NavigatorGroupName_Reference_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			ModelNavigatorGroup source = new ModelNavigatorGroup(Messages.NavigatorGroupName_Reference_4001_source,
	 ...
	 * @generated
	 */
	private Collection<ModelNavigatorItem> createNavigatorItems(Collection<View> views, Object parent, boolean isLeafs) {
