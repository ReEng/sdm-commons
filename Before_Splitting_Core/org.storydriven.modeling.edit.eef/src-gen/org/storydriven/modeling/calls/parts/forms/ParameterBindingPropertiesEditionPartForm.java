...
public class ParameterBindingPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ParameterBindingPropertiesEditionPart {
	...
	protected Composite createCommentText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(CallsViewsRepository.ParameterBinding.Properties.comment, CallsViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createParameterFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(CallsViewsRepository.ParameterBinding.Properties.parameter, CallsViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createInvocationFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(CallsViewsRepository.ParameterBinding.Properties.invocation, CallsViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.storydriven.modeling.calls.parts.ParameterBindingPropertiesEditionPart#getComment()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.storydriven.modeling.calls.parts.ParameterBindingPropertiesEditionPart#setComment(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.storydriven.modeling.calls.parts.ParameterBindingPropertiesEditionPart#getParameter()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.storydriven.modeling.calls.parts.ParameterBindingPropertiesEditionPart#initParameter(EObjectFlatComboSettings)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.storydriven.modeling.calls.parts.ParameterBindingPropertiesEditionPart#setParameter(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.storydriven.modeling.calls.parts.ParameterBindingPropertiesEditionPart#setParameterButtonMode(ButtonsModeEnum newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.storydriven.modeling.calls.parts.ParameterBindingPropertiesEditionPart#addFilterParameter(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.storydriven.modeling.calls.parts.ParameterBindingPropertiesEditionPart#addBusinessFilterParameter(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.storydriven.modeling.calls.parts.ParameterBindingPropertiesEditionPart#getInvocation()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.storydriven.modeling.calls.parts.ParameterBindingPropertiesEditionPart#initInvocation(EObjectFlatComboSettings)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.storydriven.modeling.calls.parts.ParameterBindingPropertiesEditionPart#setInvocation(EObject newValue)
	 * 
	 */
	public void setInvocation(EObject newValue) {
		if (newValue != null) {
			...
			invocation.setSelection(new StructuredSelection()); //$NON-NLS-1$
		}
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.storydriven.modeling.calls.parts.ParameterBindingPropertiesEditionPart#setInvocationButtonMode(ButtonsModeEnum newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.storydriven.modeling.calls.parts.ParameterBindingPropertiesEditionPart#addFilterInvocation(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.storydriven.modeling.calls.parts.ParameterBindingPropertiesEditionPart#addBusinessFilterInvocation(ViewerFilter filter)
	 * 
	 */
