...
public class PathPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(PatternsViewsRepository.Path.Properties.bindingSemantics)) {
				basePart.initBindingSemantics((EEnum) PatternsPackage.eINSTANCE.getAbstractLinkVariable_BindingSemantics().getEType(), path.getBindingSemantics());
			}
			if (isAccessible(PatternsViewsRepository.Path.Properties.bindingOperator)) {
				basePart.initBindingOperator((EEnum) PatternsPackage.eINSTANCE.getAbstractLinkVariable_BindingOperator().getEType(), path.getBindingOperator());
			}
			...
			if (isAccessible(PatternsViewsRepository.Path.Properties.bindingState)) {
				basePart.initBindingState((EEnum) PatternsPackage.eINSTANCE.getAbstractLinkVariable_BindingState().getEType(), path.getBindingState());
			}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (SDMPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(PatternsViewsRepository.Path.Properties.name)) {
