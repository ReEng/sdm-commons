 ...
 * @generated
 */
public class StructuredNodeStructuredNodeCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<SDMNodeDescriptor> childDescriptors = SDMDiagramUpdater
				.getStructuredNodeStructuredNodeCompartment_7001SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<SDMNodeDescriptor> childDescriptors = SDMDiagramUpdater
				.getStructuredNodeStructuredNodeCompartment_7001SemanticChildren((View) getHost()
						.getModel());
