...
import org.storydriven.modeling.diagram.edit.policies.StopNodeItemSemanticEditPolicy;
...
public class StopNodeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new StopNodeItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.storydriven.modeling.diagram.edit.parts.StopNodeEditPart) {
			types.add(SDMElementTypes.ActivityEdge_4001);
		}
