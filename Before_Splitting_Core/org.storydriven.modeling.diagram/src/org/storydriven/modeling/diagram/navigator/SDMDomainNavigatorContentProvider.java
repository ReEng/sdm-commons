 ...
 * @generated
 */
public class SDMDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public SDMDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof SDMDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((SDMDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new SDMDomainNavigatorItem((EObject) objects[i],
