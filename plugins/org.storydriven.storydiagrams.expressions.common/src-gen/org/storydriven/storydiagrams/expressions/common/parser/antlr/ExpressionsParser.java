...
public class ExpressionsParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected org.storydriven.storydiagrams.expressions.common.parser.antlr.internal.InternalExpressionsParser createParser(XtextTokenStream stream) {
		return new org.storydriven.storydiagrams.expressions.common.parser.antlr.internal.InternalExpressionsParser(stream, getGrammarAccess());
	}
