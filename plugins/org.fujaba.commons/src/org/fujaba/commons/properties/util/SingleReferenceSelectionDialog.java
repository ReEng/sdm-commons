...
public class SingleReferenceSelectionDialog extends Dialog
{
   private class PSLinkTypeLabelProvider extends LabelProvider
   {
      private AdapterFactoryLabelProvider imageProvider;


      public PSLinkTypeLabelProvider()
      {
   ...
   protected Control createDialogArea(Composite parent)
   {
      ...
      viewer.setLabelProvider(new PSLinkTypeLabelProvider());
   ...
   {
      // get reference
      selected = (EReference) selection.getFirstElement();
      ...
      PlatformUI.getWorkbench().getDisplay().syncExec(new Runnable()
      {
         ...
         {
            // create header text
            String header = ((PSLinkTypeLabelProvider) viewer
                  .getLabelProvider()).getQualifiedText(selected);

            // create image
            Image image = ((PSLinkTypeLabelProvider) viewer.getLabelProvider())
                  .getImage(selected);
