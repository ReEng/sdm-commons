...
public class ParameterExtensionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(CallsViewsRepository.ParameterExtension.Properties.extendableBase)) {
				// init part
				extendableBaseSettings = new EObjectFlatComboSettings(parameterExtension, CorePackage.eINSTANCE.getExtension_ExtendableBase());
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (CorePackage.eINSTANCE.getExtension_ExtendableBase().equals(msg.getFeature()) && basePart != null && isAccessible(CallsViewsRepository.ParameterExtension.Properties.extendableBase))
