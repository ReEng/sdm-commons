...
public class OpaqueCallablePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, OpaqueCallablePropertiesEditionPart {
	...
	protected Composite createCommentText(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(CallsViewsRepository.OpaqueCallable.Properties.comment, CallsViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createNameText(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(CallsViewsRepository.OpaqueCallable.Properties.name, CallsViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createCallExpressionFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(CallsViewsRepository.OpaqueCallable.Properties.callExpression, CallsViewsRepository.SWT_KIND), null); 
		return parent;
	}
