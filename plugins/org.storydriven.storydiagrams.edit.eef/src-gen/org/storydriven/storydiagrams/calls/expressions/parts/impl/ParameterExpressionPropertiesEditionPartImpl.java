...
public class ParameterExpressionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ParameterExpressionPropertiesEditionPart {
	...
	protected Composite createCommentText(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ExpressionsViewsRepository.ParameterExpression.Properties.comment, ExpressionsViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createParameterFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ExpressionsViewsRepository.ParameterExpression.Properties.parameter, ExpressionsViewsRepository.SWT_KIND), null); 
		return parent;
	}
