...
import org.storydriven.storydiagrams.calls.expressions.components.ParameterExpressionPropertiesEditionComponent;
...
public class ParameterExpressionPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof ParameterExpression) 
					&& (CallsExpressionsPackage.eINSTANCE.getParameterExpression() == editingContext.getEObject().eClass());
	}
