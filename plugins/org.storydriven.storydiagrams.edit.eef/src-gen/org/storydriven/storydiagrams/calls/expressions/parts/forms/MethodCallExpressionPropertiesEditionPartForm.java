...
public class MethodCallExpressionPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, MethodCallExpressionPropertiesEditionPart {
	...
	protected Composite createCommentText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ExpressionsViewsRepository.MethodCallExpression.Properties.comment, ExpressionsViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createCalleeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ExpressionsViewsRepository.MethodCallExpression.Properties.callee, ExpressionsViewsRepository.FORM_KIND), null); 
		return parent;
	}
