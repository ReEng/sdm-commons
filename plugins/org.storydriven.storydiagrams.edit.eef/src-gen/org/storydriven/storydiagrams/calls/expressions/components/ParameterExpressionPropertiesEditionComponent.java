...
public class ParameterExpressionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(ExpressionsViewsRepository.ParameterExpression.Properties.parameter)) {
				// init part
				parameterSettings = new EObjectFlatComboSettings(parameterExpression, CallsExpressionsPackage.eINSTANCE.getParameterExpression_Parameter());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == ExpressionsViewsRepository.ParameterExpression.Properties.parameter) {
			return CallsExpressionsPackage.eINSTANCE.getParameterExpression_Parameter();
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (CorePackage.eINSTANCE.getCommentableElement_Comment().equals(msg.getFeature()) && basePart != null && isAccessible(ExpressionsViewsRepository.ParameterExpression.Properties.comment)) {
			...
			if (CallsExpressionsPackage.eINSTANCE.getParameterExpression_Parameter().equals(msg.getFeature()) && basePart != null && isAccessible(ExpressionsViewsRepository.ParameterExpression.Properties.parameter))
