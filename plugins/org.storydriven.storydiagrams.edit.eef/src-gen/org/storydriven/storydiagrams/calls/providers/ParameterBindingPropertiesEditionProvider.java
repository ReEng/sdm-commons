...
import org.storydriven.storydiagrams.calls.components.ParameterBindingPropertiesEditionComponent;
...
public class ParameterBindingPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof ParameterBinding) 
					&& (CallsPackage.eINSTANCE.getParameterBinding() == editingContext.getEObject().eClass());
	}
