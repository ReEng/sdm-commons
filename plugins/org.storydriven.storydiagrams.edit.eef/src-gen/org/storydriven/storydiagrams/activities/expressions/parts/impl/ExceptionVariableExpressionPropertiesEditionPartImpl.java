 ...
 */
package org.storydriven.storydiagrams.activities.expressions.parts.impl;
...
public class ExceptionVariableExpressionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ExceptionVariableExpressionPropertiesEditionPart {
	...
	protected Composite createCommentText(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ExpressionsViewsRepository.ExceptionVariableExpression.Properties.comment, ExpressionsViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createExceptionVariableFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ExpressionsViewsRepository.ExceptionVariableExpression.Properties.exceptionVariable, ExpressionsViewsRepository.SWT_KIND), null); 
		return parent;
	}
