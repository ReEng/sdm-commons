...
public class ExpressionsMessages extends NLS {
	...
	private static final String BUNDLE_NAME = "org.storydriven.storydiagrams.activities.expressions.providers.expressionsMessages"; //$NON-NLS-1$

	
	public static String ExceptionVariableExpressionPropertiesEditionPart_PropertiesGroupLabel;

	
	public static String ExceptionVariableExpression_ReadOnly;

	
	public static String ExceptionVariableExpression_Part_Title;

	
	public static String ExceptionVariableExpressionPropertiesEditionPart_CommentLabel;

	
	public static String ExceptionVariableExpressionPropertiesEditionPart_ExceptionVariableLabel;
