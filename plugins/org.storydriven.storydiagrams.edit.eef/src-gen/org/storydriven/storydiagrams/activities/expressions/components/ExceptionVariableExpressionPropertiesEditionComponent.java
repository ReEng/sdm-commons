 ...
 */
package org.storydriven.storydiagrams.activities.expressions.components;
...
public class ExceptionVariableExpressionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(ExpressionsViewsRepository.ExceptionVariableExpression.Properties.exceptionVariable)) {
				// init part
				exceptionVariableSettings = new EObjectFlatComboSettings(exceptionVariableExpression, ActivitiesExpressionsPackage.eINSTANCE.getExceptionVariableExpression_ExceptionVariable());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == ExpressionsViewsRepository.ExceptionVariableExpression.Properties.exceptionVariable) {
			return ActivitiesExpressionsPackage.eINSTANCE.getExceptionVariableExpression_ExceptionVariable();
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (CorePackage.eINSTANCE.getCommentableElement_Comment().equals(msg.getFeature()) && basePart != null && isAccessible(ExpressionsViewsRepository.ExceptionVariableExpression.Properties.comment)) {
			...
			if (ActivitiesExpressionsPackage.eINSTANCE.getExceptionVariableExpression_ExceptionVariable().equals(msg.getFeature()) && basePart != null && isAccessible(ExpressionsViewsRepository.ExceptionVariableExpression.Properties.exceptionVariable))
