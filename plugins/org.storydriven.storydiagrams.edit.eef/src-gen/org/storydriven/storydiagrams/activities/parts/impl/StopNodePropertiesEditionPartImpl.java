...
public class StopNodePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, StopNodePropertiesEditionPart {
	...
	protected Composite createCommentText(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.StopNode.Properties.comment, ActivitiesViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createNameText(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.StopNode.Properties.name, ActivitiesViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createOwningActivityFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.StopNode.Properties.owningActivity, ActivitiesViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createOwningActivityNodeFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.StopNode.Properties.owningActivityNode, ActivitiesViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createFlowStopOnlyCheckbox(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.StopNode.Properties.flowStopOnly, ActivitiesViewsRepository.SWT_KIND), null); 
		return parent;
	}
