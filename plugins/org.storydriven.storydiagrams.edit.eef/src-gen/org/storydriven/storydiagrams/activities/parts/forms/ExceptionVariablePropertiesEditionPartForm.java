...
public class ExceptionVariablePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ExceptionVariablePropertiesEditionPart {
	...
	protected Composite createActivityEdgeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.ExceptionVariable.Properties.activityEdge, ActivitiesViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.ExceptionVariable.Properties.name, ActivitiesViewsRepository.FORM_KIND), null); 
		return parent;
	}
