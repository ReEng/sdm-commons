...
public class ActivityCallNodePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ActivityCallNodePropertiesEditionPart {
	...
	protected Composite createCommentText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.ActivityCallNode.Properties.comment, ActivitiesViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.ActivityCallNode.Properties.name, ActivitiesViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createOwningActivityFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.ActivityCallNode.Properties.owningActivity, ActivitiesViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createOwningActivityNodeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.ActivityCallNode.Properties.owningActivityNode, ActivitiesViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createCalleeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.ActivityCallNode.Properties.callee, ActivitiesViewsRepository.FORM_KIND), null); 
		return parent;
	}
