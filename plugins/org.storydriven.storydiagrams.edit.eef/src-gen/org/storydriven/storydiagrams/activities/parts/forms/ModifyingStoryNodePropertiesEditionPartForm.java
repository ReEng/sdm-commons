...
public class ModifyingStoryNodePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ModifyingStoryNodePropertiesEditionPart {
	...
	protected Composite createCommentText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.ModifyingStoryNode.Properties.comment, ActivitiesViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.ModifyingStoryNode.Properties.name, ActivitiesViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createOwningActivityFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.ModifyingStoryNode.Properties.owningActivity, ActivitiesViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createOwningActivityNodeFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.ModifyingStoryNode.Properties.owningActivityNode, ActivitiesViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createForEachCheckbox(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.ModifyingStoryNode.Properties.forEach, ActivitiesViewsRepository.FORM_KIND), null); 
		return parent;
	}
