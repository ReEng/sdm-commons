...
public class MatchingStoryNodePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, MatchingStoryNodePropertiesEditionPart {
	...
	protected Composite createCommentText(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.MatchingStoryNode.Properties.comment, ActivitiesViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createNameText(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.MatchingStoryNode.Properties.name, ActivitiesViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createOwningActivityFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.MatchingStoryNode.Properties.owningActivity, ActivitiesViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createOwningActivityNodeFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.MatchingStoryNode.Properties.owningActivityNode, ActivitiesViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createForEachCheckbox(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.MatchingStoryNode.Properties.forEach, ActivitiesViewsRepository.SWT_KIND), null); 
		return parent;
	}
