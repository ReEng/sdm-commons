...
public class StatementNodePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, StatementNodePropertiesEditionPart {
	...
	protected Composite createCommentText(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.StatementNode.Properties.comment, ActivitiesViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createNameText(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.StatementNode.Properties.name, ActivitiesViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createOwningActivityFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.StatementNode.Properties.owningActivity, ActivitiesViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createOwningActivityNodeFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.StatementNode.Properties.owningActivityNode, ActivitiesViewsRepository.SWT_KIND), null); 
		return parent;
	}
