...
public class ActivityPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ActivityPropertiesEditionPart {
	...
	protected Composite createCommentText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.Activity.Properties.comment, ActivitiesViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.Activity.Properties.name, ActivitiesViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createOwningOperationFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.Activity.Properties.owningOperation, ActivitiesViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createPreconditionFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.Activity.Properties.precondition, ActivitiesViewsRepository.FORM_KIND), null); 
		return parent;
	}
