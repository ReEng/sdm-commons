...
public class OperationExtensionPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, OperationExtensionPropertiesEditionPart {
	...
	protected Composite createCommentText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.OperationExtension.Properties.comment, ActivitiesViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createExtendableBaseFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.OperationExtension.Properties.extendableBase, ActivitiesViewsRepository.FORM_KIND), null); 
		return parent;
	}
