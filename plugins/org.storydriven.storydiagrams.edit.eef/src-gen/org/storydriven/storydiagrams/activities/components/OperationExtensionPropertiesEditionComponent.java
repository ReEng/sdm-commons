...
public class OperationExtensionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(ActivitiesViewsRepository.OperationExtension.Properties.extendableBase)) {
				// init part
				extendableBaseSettings = new EObjectFlatComboSettings(operationExtension, CorePackage.eINSTANCE.getExtension_ExtendableBase());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == ActivitiesViewsRepository.OperationExtension.Properties.extendableBase) {
			return CorePackage.eINSTANCE.getExtension_ExtendableBase();
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (CorePackage.eINSTANCE.getCommentableElement_Comment().equals(msg.getFeature()) && basePart != null && isAccessible(ActivitiesViewsRepository.OperationExtension.Properties.comment)) {
			...
			if (CorePackage.eINSTANCE.getExtension_ExtendableBase().equals(msg.getFeature()) && basePart != null && isAccessible(ActivitiesViewsRepository.OperationExtension.Properties.extendableBase))
