 ...
 */
package org.storydriven.storydiagrams.providers;
 ...
 * 
 */
public class StorydiagramsMessages extends NLS {
	
	private static final String BUNDLE_NAME = "org.storydriven.storydiagrams.providers.storydiagramsMessages"; //$NON-NLS-1$
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, StorydiagramsMessages.class);
	}

	
	private StorydiagramsMessages() {
