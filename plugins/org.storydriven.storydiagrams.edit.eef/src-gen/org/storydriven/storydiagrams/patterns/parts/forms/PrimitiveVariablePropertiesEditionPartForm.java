...
public class PrimitiveVariablePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, PrimitiveVariablePropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.PrimitiveVariable.Properties.name, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createPatternFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.PrimitiveVariable.Properties.pattern, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createBindingStateEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.PrimitiveVariable.Properties.bindingState, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createClassifierFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.PrimitiveVariable.Properties.classifier, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
