...
public class StoryPatternPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, StoryPatternPropertiesEditionPart {
	...
	protected Composite createCommentText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.StoryPattern.Properties.comment, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createParentPatternFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.StoryPattern.Properties.parentPattern, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createBindingSemanticsEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.StoryPattern.Properties.bindingSemantics, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
