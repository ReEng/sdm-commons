...
public class ConstraintPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ConstraintPropertiesEditionPart {
	...
	protected Composite createPatternFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.Constraint.Properties.pattern, PatternsViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createObjectVariableFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.Constraint.Properties.objectVariable, PatternsViewsRepository.SWT_KIND), null); 
		return parent;
	}
