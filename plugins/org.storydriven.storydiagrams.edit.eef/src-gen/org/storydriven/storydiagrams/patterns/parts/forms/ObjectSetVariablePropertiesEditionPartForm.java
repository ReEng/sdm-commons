...
public class ObjectSetVariablePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ObjectSetVariablePropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.ObjectSetVariable.Properties.name, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createPatternFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.ObjectSetVariable.Properties.pattern, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createBindingStateEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.ObjectSetVariable.Properties.bindingState, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createBindingSemanticsEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.ObjectSetVariable.Properties.bindingSemantics, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createBindingOperatorEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.ObjectSetVariable.Properties.bindingOperator, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createClassifierFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.ObjectSetVariable.Properties.classifier, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
