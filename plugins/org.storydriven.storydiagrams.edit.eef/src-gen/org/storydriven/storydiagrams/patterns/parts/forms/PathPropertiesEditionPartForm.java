...
public class PathPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, PathPropertiesEditionPart {
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.Path.Properties.name, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createBindingSemanticsEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.Path.Properties.bindingSemantics, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createBindingOperatorEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.Path.Properties.bindingOperator, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createSourceFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.Path.Properties.source, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createBindingStateEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.Path.Properties.bindingState, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createPatternFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.Path.Properties.pattern, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createTargetFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.Path.Properties.target, PatternsViewsRepository.FORM_KIND), null); 
		return parent;
	}
