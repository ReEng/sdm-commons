...
public class ContainerVariablePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ContainerVariablePropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.ContainerVariable.Properties.name, PatternsViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createPatternFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.ContainerVariable.Properties.pattern, PatternsViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createBindingStateEMFComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.ContainerVariable.Properties.bindingState, PatternsViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createIncomingLinkAdvancedReferencesTable(Composite parent) {
		this.incomingLink = new ReferencesTable(
				PatternsMessages.ContainerVariablePropertiesEditionPart_IncomingLinkLabel,
				new org.eclipse.emf.eef.runtime.ui.widgets.ReferencesTable.ReferencesTableListener() {
			@Override
	...
	protected Composite createOutgoingLinkAdvancedReferencesTable(Composite parent) {
		this.outgoingLink = new ReferencesTable(
				PatternsMessages.ContainerVariablePropertiesEditionPart_OutgoingLinkLabel,
				new org.eclipse.emf.eef.runtime.ui.widgets.ReferencesTable.ReferencesTableListener() {
			@Override
	...
	protected Composite createBindingSemanticsEMFComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.ContainerVariable.Properties.bindingSemantics, PatternsViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createBindingOperatorEMFComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.ContainerVariable.Properties.bindingOperator, PatternsViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createClassifierFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.ContainerVariable.Properties.classifier, PatternsViewsRepository.SWT_KIND), null); 
		return parent;
	}
