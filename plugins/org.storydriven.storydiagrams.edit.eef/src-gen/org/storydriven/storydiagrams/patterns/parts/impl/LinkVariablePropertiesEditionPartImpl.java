...
public class LinkVariablePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, LinkVariablePropertiesEditionPart {
	...
	protected Composite createNameText(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.LinkVariable.Properties.name, PatternsViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createBindingSemanticsEMFComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.LinkVariable.Properties.bindingSemantics, PatternsViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createBindingOperatorEMFComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.LinkVariable.Properties.bindingOperator, PatternsViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createSourceFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.LinkVariable.Properties.source, PatternsViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createBindingStateEMFComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.LinkVariable.Properties.bindingState, PatternsViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createPatternFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.LinkVariable.Properties.pattern, PatternsViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createTargetFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.LinkVariable.Properties.target, PatternsViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createTargetEndFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(PatternsViewsRepository.LinkVariable.Properties.targetEnd, PatternsViewsRepository.SWT_KIND), null); 
		return parent;
	}
