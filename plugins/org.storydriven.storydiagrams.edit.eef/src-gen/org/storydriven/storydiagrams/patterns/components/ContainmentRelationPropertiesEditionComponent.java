...
public class ContainmentRelationPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(PatternsViewsRepository.ContainmentRelation.Properties.bindingSemantics)) {
				basePart.initBindingSemantics(EEFUtils.choiceOfValues(containmentRelation, PatternsPackage.eINSTANCE.getAbstractLinkVariable_BindingSemantics()), containmentRelation.getBindingSemantics());
			}
			if (isAccessible(PatternsViewsRepository.ContainmentRelation.Properties.bindingOperator)) {
				basePart.initBindingOperator(EEFUtils.choiceOfValues(containmentRelation, PatternsPackage.eINSTANCE.getAbstractLinkVariable_BindingOperator()), containmentRelation.getBindingOperator());
			}
			...
			if (isAccessible(PatternsViewsRepository.ContainmentRelation.Properties.bindingState)) {
				basePart.initBindingState(EEFUtils.choiceOfValues(containmentRelation, PatternsPackage.eINSTANCE.getAbstractLinkVariable_BindingState()), containmentRelation.getBindingState());
			}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (CorePackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(PatternsViewsRepository.ContainmentRelation.Properties.name)) {
