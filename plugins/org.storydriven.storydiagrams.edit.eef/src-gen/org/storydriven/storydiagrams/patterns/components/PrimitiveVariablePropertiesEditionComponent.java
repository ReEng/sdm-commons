...
public class PrimitiveVariablePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(PatternsViewsRepository.PrimitiveVariable.Properties.bindingState)) {
				basePart.initBindingState(EEFUtils.choiceOfValues(primitiveVariable, PatternsPackage.eINSTANCE.getAbstractVariable_BindingState()), primitiveVariable.getBindingState());
			}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (CorePackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(PatternsViewsRepository.PrimitiveVariable.Properties.name)) {
