...
public class LinkVariablePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(PatternsViewsRepository.LinkVariable.Properties.bindingSemantics)) {
				basePart.initBindingSemantics(EEFUtils.choiceOfValues(linkVariable, PatternsPackage.eINSTANCE.getAbstractLinkVariable_BindingSemantics()), linkVariable.getBindingSemantics());
			}
			if (isAccessible(PatternsViewsRepository.LinkVariable.Properties.bindingOperator)) {
				basePart.initBindingOperator(EEFUtils.choiceOfValues(linkVariable, PatternsPackage.eINSTANCE.getAbstractLinkVariable_BindingOperator()), linkVariable.getBindingOperator());
			}
			...
			if (isAccessible(PatternsViewsRepository.LinkVariable.Properties.bindingState)) {
				basePart.initBindingState(EEFUtils.choiceOfValues(linkVariable, PatternsPackage.eINSTANCE.getAbstractLinkVariable_BindingState()), linkVariable.getBindingState());
			}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (CorePackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(PatternsViewsRepository.LinkVariable.Properties.name)) {
