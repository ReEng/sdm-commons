...
public class ContainerVariablePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(PatternsViewsRepository.ContainerVariable.Properties.bindingState)) {
				basePart.initBindingState(EEFUtils.choiceOfValues(containerVariable, PatternsPackage.eINSTANCE.getAbstractVariable_BindingState()), containerVariable.getBindingState());
			}
			...
			if (isAccessible(PatternsViewsRepository.ContainerVariable.Properties.bindingSemantics)) {
				basePart.initBindingSemantics(EEFUtils.choiceOfValues(containerVariable, PatternsPackage.eINSTANCE.getObjectVariable_BindingSemantics()), containerVariable.getBindingSemantics());
			}
			if (isAccessible(PatternsViewsRepository.ContainerVariable.Properties.bindingOperator)) {
				basePart.initBindingOperator(EEFUtils.choiceOfValues(containerVariable, PatternsPackage.eINSTANCE.getObjectVariable_BindingOperator()), containerVariable.getBindingOperator());
			}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (CorePackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(PatternsViewsRepository.ContainerVariable.Properties.name)) {
