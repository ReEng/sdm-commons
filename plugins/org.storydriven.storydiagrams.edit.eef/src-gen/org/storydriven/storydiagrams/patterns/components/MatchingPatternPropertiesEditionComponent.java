...
public class MatchingPatternPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(PatternsViewsRepository.MatchingPattern.Properties.bindingSemantics)) {
				basePart.initBindingSemantics(EEFUtils.choiceOfValues(matchingPattern, PatternsPackage.eINSTANCE.getStoryPattern_BindingSemantics()), matchingPattern.getBindingSemantics());
			}
			// init filters
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (CorePackage.eINSTANCE.getCommentableElement_Comment().equals(msg.getFeature()) && basePart != null && isAccessible(PatternsViewsRepository.MatchingPattern.Properties.comment)) {
