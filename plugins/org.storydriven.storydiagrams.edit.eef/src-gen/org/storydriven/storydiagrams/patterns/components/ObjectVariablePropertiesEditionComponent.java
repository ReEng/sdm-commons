...
public class ObjectVariablePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(PatternsViewsRepository.ObjectVariable.Properties.bindingState)) {
				basePart.initBindingState(EEFUtils.choiceOfValues(objectVariable, PatternsPackage.eINSTANCE.getAbstractVariable_BindingState()), objectVariable.getBindingState());
			}
			...
			if (isAccessible(PatternsViewsRepository.ObjectVariable.Properties.bindingSemantics)) {
				basePart.initBindingSemantics(EEFUtils.choiceOfValues(objectVariable, PatternsPackage.eINSTANCE.getObjectVariable_BindingSemantics()), objectVariable.getBindingSemantics());
			}
			if (isAccessible(PatternsViewsRepository.ObjectVariable.Properties.bindingOperator)) {
				basePart.initBindingOperator(EEFUtils.choiceOfValues(objectVariable, PatternsPackage.eINSTANCE.getObjectVariable_BindingOperator()), objectVariable.getBindingOperator());
			}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (CorePackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && basePart != null && isAccessible(PatternsViewsRepository.ObjectVariable.Properties.name)) {
