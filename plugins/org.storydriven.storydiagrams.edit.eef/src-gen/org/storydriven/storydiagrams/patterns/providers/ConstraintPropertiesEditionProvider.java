...
import org.storydriven.storydiagrams.patterns.components.ConstraintPropertiesEditionComponent;
...
public class ConstraintPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Constraint) 
					&& (PatternsPackage.eINSTANCE.getConstraint() == editingContext.getEObject().eClass());
	}
