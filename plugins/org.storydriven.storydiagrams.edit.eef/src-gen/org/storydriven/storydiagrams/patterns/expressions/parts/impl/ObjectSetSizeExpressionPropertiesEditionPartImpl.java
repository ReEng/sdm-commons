...
public class ObjectSetSizeExpressionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ObjectSetSizeExpressionPropertiesEditionPart {
	...
	protected Composite createCommentText(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ExpressionsViewsRepository.ObjectSetSizeExpression.Properties.comment, ExpressionsViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createSetFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ExpressionsViewsRepository.ObjectSetSizeExpression.Properties.set, ExpressionsViewsRepository.SWT_KIND), null); 
		return parent;
	}
