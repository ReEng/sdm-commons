...
public class PrimitiveVariableExpressionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, PrimitiveVariableExpressionPropertiesEditionPart {
	...
	protected Composite createCommentText(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ExpressionsViewsRepository.PrimitiveVariableExpression.Properties.comment, ExpressionsViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createPrimitiveVariableFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ExpressionsViewsRepository.PrimitiveVariableExpression.Properties.primitiveVariable, ExpressionsViewsRepository.SWT_KIND), null); 
		return parent;
	}
