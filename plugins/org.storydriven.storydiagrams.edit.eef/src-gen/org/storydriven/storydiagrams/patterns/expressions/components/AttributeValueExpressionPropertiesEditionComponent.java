...
public class AttributeValueExpressionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(ExpressionsViewsRepository.AttributeValueExpression.Properties.object)) {
				// init part
				objectSettings = new EObjectFlatComboSettings(attributeValueExpression, PatternsExpressionsPackage.eINSTANCE.getAttributeValueExpression_Object());
			...
			if (isAccessible(ExpressionsViewsRepository.AttributeValueExpression.Properties.attribute)) {
				// init part
				attributeSettings = new EObjectFlatComboSettings(attributeValueExpression, PatternsExpressionsPackage.eINSTANCE.getAttributeValueExpression_Attribute());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == ExpressionsViewsRepository.AttributeValueExpression.Properties.object) {
			return PatternsExpressionsPackage.eINSTANCE.getAttributeValueExpression_Object();
		}
		if (editorKey == ExpressionsViewsRepository.AttributeValueExpression.Properties.attribute) {
			return PatternsExpressionsPackage.eINSTANCE.getAttributeValueExpression_Attribute();
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (CorePackage.eINSTANCE.getCommentableElement_Comment().equals(msg.getFeature()) && basePart != null && isAccessible(ExpressionsViewsRepository.AttributeValueExpression.Properties.comment)) {
			...
			if (PatternsExpressionsPackage.eINSTANCE.getAttributeValueExpression_Object().equals(msg.getFeature()) && basePart != null && isAccessible(ExpressionsViewsRepository.AttributeValueExpression.Properties.object))
				basePart.setObject((EObject)msg.getNewValue());
			if (PatternsExpressionsPackage.eINSTANCE.getAttributeValueExpression_Attribute().equals(msg.getFeature()) && basePart != null && isAccessible(ExpressionsViewsRepository.AttributeValueExpression.Properties.attribute))
