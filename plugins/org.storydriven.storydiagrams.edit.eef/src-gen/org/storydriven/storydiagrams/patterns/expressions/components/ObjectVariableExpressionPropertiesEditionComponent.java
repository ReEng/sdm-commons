...
public class ObjectVariableExpressionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(ExpressionsViewsRepository.ObjectVariableExpression.Properties.object)) {
				// init part
				objectSettings = new EObjectFlatComboSettings(objectVariableExpression, PatternsExpressionsPackage.eINSTANCE.getObjectVariableExpression_Object());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == ExpressionsViewsRepository.ObjectVariableExpression.Properties.object) {
			return PatternsExpressionsPackage.eINSTANCE.getObjectVariableExpression_Object();
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (CorePackage.eINSTANCE.getCommentableElement_Comment().equals(msg.getFeature()) && basePart != null && isAccessible(ExpressionsViewsRepository.ObjectVariableExpression.Properties.comment)) {
			...
			if (PatternsExpressionsPackage.eINSTANCE.getObjectVariableExpression_Object().equals(msg.getFeature()) && basePart != null && isAccessible(ExpressionsViewsRepository.ObjectVariableExpression.Properties.object))
