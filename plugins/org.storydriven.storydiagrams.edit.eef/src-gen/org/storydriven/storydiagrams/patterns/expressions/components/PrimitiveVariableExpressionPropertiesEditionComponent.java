...
public class PrimitiveVariableExpressionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(ExpressionsViewsRepository.PrimitiveVariableExpression.Properties.primitiveVariable)) {
				// init part
				primitiveVariableSettings = new EObjectFlatComboSettings(primitiveVariableExpression, PatternsExpressionsPackage.eINSTANCE.getPrimitiveVariableExpression_PrimitiveVariable());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == ExpressionsViewsRepository.PrimitiveVariableExpression.Properties.primitiveVariable) {
			return PatternsExpressionsPackage.eINSTANCE.getPrimitiveVariableExpression_PrimitiveVariable();
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (CorePackage.eINSTANCE.getCommentableElement_Comment().equals(msg.getFeature()) && basePart != null && isAccessible(ExpressionsViewsRepository.PrimitiveVariableExpression.Properties.comment)) {
			...
			if (PatternsExpressionsPackage.eINSTANCE.getPrimitiveVariableExpression_PrimitiveVariable().equals(msg.getFeature()) && basePart != null && isAccessible(ExpressionsViewsRepository.PrimitiveVariableExpression.Properties.primitiveVariable))
