...
public class TemplateBindingPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, TemplateBindingPropertiesEditionPart {
	...
	protected Composite createBoundParameterFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(TemplatesViewsRepository.TemplateBinding.Properties.boundParameter, TemplatesViewsRepository.SWT_KIND), null); 
		return parent;
	}
	...
	protected Composite createTemplateFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(TemplatesViewsRepository.TemplateBinding.Properties.template, TemplatesViewsRepository.SWT_KIND), null); 
		return parent;
	}
