...
public class PropertyBindingPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, PropertyBindingPropertiesEditionPart {
	...
	protected Composite createBoundPropertyFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(TemplatesViewsRepository.PropertyBinding.Properties.boundProperty, TemplatesViewsRepository.FORM_KIND), null); 
		return parent;
	}
	...
	protected Composite createTemplateBindingFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(TemplatesViewsRepository.PropertyBinding.Properties.templateBinding, TemplatesViewsRepository.FORM_KIND), null); 
		return parent;
	}
