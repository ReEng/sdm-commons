...
/**
 * This is the item provider adapter for a {@link org.storydriven.storydiagrams.interpreter.tests.TInterface} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class TInterfaceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_TInterface_type") : //$NON-NLS-1$
				getString("_UI_TInterface_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
