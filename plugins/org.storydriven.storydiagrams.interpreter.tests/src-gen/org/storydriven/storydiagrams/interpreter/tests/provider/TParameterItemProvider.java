...
/**
 * This is the item provider adapter for a {@link org.storydriven.storydiagrams.interpreter.tests.TParameter} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class TParameterItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addMethodPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(),
						getString("_UI_TParameter_method_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_TParameter_method_feature", "_UI_TParameter_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						TestsPackage.Literals.TPARAMETER__METHOD, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_TParameter_type") : //$NON-NLS-1$
				getString("_UI_TParameter_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
