...
public abstract class CallableImpl extends CommentableElementImpl implements Callable {
	...
	public EList<EParameter> getInParameters() {
		if (inParameters == null) {
			inParameters = new EObjectResolvingEList<EParameter>(EParameter.class, this, CallsPackage.CALLABLE__IN_PARAMETER);
		}
		return inParameters;
	}
	...
	public EList<EParameter> getOutParameters() {
		if (outParameters == null) {
			outParameters = new EObjectResolvingEList<EParameter>(EParameter.class, this, CallsPackage.CALLABLE__OUT_PARAMETER);
		}
