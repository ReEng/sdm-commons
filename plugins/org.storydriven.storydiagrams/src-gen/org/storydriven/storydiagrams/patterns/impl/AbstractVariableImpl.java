...
public abstract class AbstractVariableImpl extends VariableImpl implements AbstractVariable {
	...
	public EList<Constraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectContainmentWithInverseEList<Constraint>(Constraint.class, this, PatternsPackage.ABSTRACT_VARIABLE__CONSTRAINT, PatternsPackage.CONSTRAINT__OBJECT_VARIABLE);
		}
		return constraints;
	}
	...
	public EList<AbstractLinkVariable> getIncomingLinks() {
		if (incomingLinks == null) {
			incomingLinks = new EObjectWithInverseResolvingEList<AbstractLinkVariable>(AbstractLinkVariable.class, this, PatternsPackage.ABSTRACT_VARIABLE__INCOMING_LINK, PatternsPackage.ABSTRACT_LINK_VARIABLE__TARGET);
		}
