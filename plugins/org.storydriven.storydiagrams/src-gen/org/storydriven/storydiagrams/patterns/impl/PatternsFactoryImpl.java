...
public class PatternsFactoryImpl extends EFactoryImpl implements PatternsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case PatternsPackage.OBJECT_SET_VARIABLE: return createObjectSetVariable();
			...
			case PatternsPackage.CONTAINMENT_RELATION: return createContainmentRelation();
			case PatternsPackage.MATCHING_PATTERN: return createMatchingPattern();
			case PatternsPackage.CONTAINER_VARIABLE: return createContainerVariable();
