...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Abstract Link Variable</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link org.storydriven.storydiagrams.patterns.impl.AbstractLinkVariableImpl#getBindingState <em>Binding State</em>}</li>
...
public abstract class AbstractLinkVariableImpl extends NamedElementImpl implements AbstractLinkVariable {
	...
	public EList<LinkConstraint> getSecondLinkConstraints() {
		if (secondLinkConstraints == null) {
			secondLinkConstraints = new EObjectWithInverseResolvingEList<LinkConstraint>(LinkConstraint.class, this, PatternsPackage.ABSTRACT_LINK_VARIABLE__SECOND_LINK_CONSTRAINT, PatternsPackage.LINK_CONSTRAINT__SECOND_LINK);
		}
	...
	public EList<LinkConstraint> getFirstLinkConstraints() {
		if (firstLinkConstraints == null) {
			firstLinkConstraints = new EObjectWithInverseResolvingEList<LinkConstraint>(LinkConstraint.class, this, PatternsPackage.ABSTRACT_LINK_VARIABLE__FIRST_LINK_CONSTRAINT, PatternsPackage.LINK_CONSTRAINT__FIRST_LINK);
		}
	...
	public void setBindingState(BindingState newBindingState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PatternsPackage.ABSTRACT_LINK_VARIABLE__BINDING_STATE, oldBindingState, bindingState));
	}
