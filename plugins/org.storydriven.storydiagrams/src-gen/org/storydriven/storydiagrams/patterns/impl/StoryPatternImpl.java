...
public class StoryPatternImpl extends CommentableElementImpl implements StoryPattern {
	...
	public EList<AbstractVariable> getVariables() {
		if (variables == null) {
			variables = new EObjectContainmentWithInverseEList<AbstractVariable>(AbstractVariable.class, this, PatternsPackage.STORY_PATTERN__VARIABLE, PatternsPackage.ABSTRACT_VARIABLE__PATTERN);
		}
		return variables;
	}
	...
	public EList<Constraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectContainmentWithInverseEList<Constraint>(Constraint.class, this, PatternsPackage.STORY_PATTERN__CONSTRAINT, PatternsPackage.CONSTRAINT__PATTERN);
		}
		return constraints;
	}
	...
	public EList<AbstractLinkVariable> getLinkVariables() {
		if (linkVariables == null) {
			linkVariables = new EObjectContainmentWithInverseEList<AbstractLinkVariable>(AbstractLinkVariable.class, this, PatternsPackage.STORY_PATTERN__LINK_VARIABLE, PatternsPackage.ABSTRACT_LINK_VARIABLE__PATTERN);
		}
	...
	public EList<StoryPattern> getContainedPatterns() {
		if (containedPatterns == null) {
			containedPatterns = new EObjectContainmentWithInverseEList<StoryPattern>(StoryPattern.class, this, PatternsPackage.STORY_PATTERN__CONTAINED_PATTERN, PatternsPackage.STORY_PATTERN__PARENT_PATTERN);
		}
