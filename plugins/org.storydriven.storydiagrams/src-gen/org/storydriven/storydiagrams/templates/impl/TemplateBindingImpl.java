...
public class TemplateBindingImpl extends ExtendableElementImpl implements TemplateBinding {
	...
	public EList<PropertyBinding> getPropertyBindings() {
		if (propertyBindings == null) {
			propertyBindings = new EObjectContainmentWithInverseEList<PropertyBinding>(PropertyBinding.class, this, TemplatesPackage.TEMPLATE_BINDING__PROPERTY_BINDING, TemplatesPackage.PROPERTY_BINDING__TEMPLATE_BINDING);
		}
