...
public class ActivityEdgeImpl extends ExtendableElementImpl implements ActivityEdge {
	...
	public EList<ExceptionVariable> getGuardExceptions() {
		if (guardExceptions == null) {
			guardExceptions = new EObjectContainmentWithInverseEList<ExceptionVariable>(ExceptionVariable.class, this, ActivitiesPackage.ACTIVITY_EDGE__GUARD_EXCEPTION, ActivitiesPackage.EXCEPTION_VARIABLE__ACTIVITY_EDGE);
		}
