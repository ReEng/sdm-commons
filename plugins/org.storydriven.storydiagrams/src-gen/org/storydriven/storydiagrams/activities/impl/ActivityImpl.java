...
public class ActivityImpl extends CallableImpl implements Activity {
	...
	public EList<ActivityEdge> getOwnedActivityEdges() {
		if (ownedActivityEdges == null) {
			ownedActivityEdges = new EObjectContainmentWithInverseEList<ActivityEdge>(ActivityEdge.class, this, ActivitiesPackage.ACTIVITY__OWNED_ACTIVITY_EDGE, ActivitiesPackage.ACTIVITY_EDGE__OWNING_ACTIVITY);
		}
	...
	public EList<ActivityNode> getOwnedActivityNodes() {
		if (ownedActivityNodes == null) {
			ownedActivityNodes = new EObjectContainmentWithInverseEList<ActivityNode>(ActivityNode.class, this, ActivitiesPackage.ACTIVITY__OWNED_ACTIVITY_NODE, ActivitiesPackage.ACTIVITY_NODE__OWNING_ACTIVITY);
		}
