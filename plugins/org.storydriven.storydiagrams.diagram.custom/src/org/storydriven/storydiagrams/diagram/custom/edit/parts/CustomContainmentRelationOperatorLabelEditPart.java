...
public class CustomContainmentRelationOperatorLabelEditPart extends ContainmentRelationOperatorLabelEditPart {
	public CustomContainmentRelationOperatorLabelEditPart(View view) {
		super(view);
	}
