...
public class CommonExpressionsPackageImpl extends EPackageImpl implements
	...
	public EAttribute getLogicExpression_Operator() {
		return (EAttribute) logicExpressionEClass.getEStructuralFeatures().get(
				0);
	}
	...
	public void initializePackageContents() {
		...
		literalExpressionEClass.getESuperTypes().add(
				theExpressionsPackage.getExpression());
		booleanLiteralExpressionEClass.getESuperTypes().add(
				this.getLiteralExpression());
		integerLiteralExpressionEClass.getESuperTypes().add(
				this.getLiteralExpression());
		doubleLiteralExpressionEClass.getESuperTypes().add(
				this.getLiteralExpression());
		stringLiteralExpressionEClass.getESuperTypes().add(
				this.getLiteralExpression());
		...
		initEClass(logicExpressionEClass, LogicExpression.class,
				"LogicExpression", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLogicExpression_Operator(), this.getLogicOperator(),
				"operator", null, 1, 1, LogicExpression.class, !IS_TRANSIENT,
		...
		initEClass(booleanLiteralExpressionEClass,
				BooleanLiteralExpression.class, "BooleanLiteralExpression",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(integerLiteralExpressionEClass,
				IntegerLiteralExpression.class, "IntegerLiteralExpression",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(doubleLiteralExpressionEClass,
				DoubleLiteralExpression.class, "DoubleLiteralExpression",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(stringLiteralExpressionEClass,
				StringLiteralExpression.class, "StringLiteralExpression",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
