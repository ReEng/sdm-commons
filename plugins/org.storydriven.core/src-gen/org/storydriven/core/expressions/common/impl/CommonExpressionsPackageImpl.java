...
public class CommonExpressionsPackageImpl extends EPackageImpl implements CommonExpressionsPackage {
	 ...
	 * @generated
	 */
	private EClass doubleLiteralExpressionEClass = null;
	 ...
	 * @generated
	 */
	public EAttribute getLogicExpression_Operator() {
		return (EAttribute) logicExpressionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getDoubleLiteralExpression() {
		return doubleLiteralExpressionEClass;
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(logicExpressionEClass, LOGIC_EXPRESSION__OPERATOR);
		...
		doubleLiteralExpressionEClass = createEClass(DOUBLE_LITERAL_EXPRESSION);
	...
	public void initializePackageContents() {
		...
		doubleLiteralExpressionEClass.getESuperTypes().add(this.getLiteralExpression());
		...
		initEClass(logicExpressionEClass, LogicExpression.class, "LogicExpression", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLogicExpression_Operator(), this.getLogicOperator(), "operator", null, 1, 1,
				LogicExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
		...
		initEClass(booleanLiteralExpressionEClass, BooleanLiteralExpression.class, "BooleanLiteralExpression",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(integerLiteralExpressionEClass, IntegerLiteralExpression.class, "IntegerLiteralExpression",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(doubleLiteralExpressionEClass, DoubleLiteralExpression.class, "DoubleLiteralExpression",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(stringLiteralExpressionEClass, StringLiteralExpression.class, "StringLiteralExpression",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createGenModelAnnotations() {
		...
		addAnnotation(logicExpressionEClass, source, new String[] { "documentation",
				"Represents binary, logic expressions like a AND b and a OR b." });
		addAnnotation(getLogicExpression_Operator(), source, new String[] { "documentation",
