...
public class EModelElementOperations
{
   ...
   {
      EAnnotation annotation = getAnnotation(baseElement, CorePackage.EXTENSION_NS_URI);
   ...
   {
      EAnnotation annotation = provideAnnotation(baseElement, CorePackage.EXTENSION_NS_URI);
