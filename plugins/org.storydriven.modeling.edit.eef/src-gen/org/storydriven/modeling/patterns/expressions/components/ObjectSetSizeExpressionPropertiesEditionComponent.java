...
public class ObjectSetSizeExpressionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(ExpressionsViewsRepository.ObjectSetSizeExpression.Properties.set)) {
				// init part
				setSettings = new EObjectFlatComboSettings(objectSetSizeExpression, ExpressionsPackage.eINSTANCE.getObjectSetSizeExpression_Set());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == ExpressionsViewsRepository.ObjectSetSizeExpression.Properties.set) {
			return ExpressionsPackage.eINSTANCE.getObjectSetSizeExpression_Set();
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (SDMPackage.eINSTANCE.getCommentableElement_Comment().equals(msg.getFeature()) && basePart != null && isAccessible(ExpressionsViewsRepository.ObjectSetSizeExpression.Properties.comment)) {
			...
			if (ExpressionsPackage.eINSTANCE.getObjectSetSizeExpression_Set().equals(msg.getFeature()) && basePart != null && isAccessible(ExpressionsViewsRepository.ObjectSetSizeExpression.Properties.set))
