 ...
 * @generated
 */
public class StatementNodeStatementNodeCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getStatementNodeStatementNodeCompartment_7016SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getStatementNodeStatementNodeCompartment_7016SemanticChildren((View) getHost()
						.getModel());
