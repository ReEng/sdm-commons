 ...
 * @generated
 */
public class ModifyingStoryNodeModifyingStoryNodeContentCompartment2CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<SDMNodeDescriptor> childDescriptors = SDMDiagramUpdater
				.getModifyingStoryNodeModifyingStoryNodeContentCompartment_7007SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return StoryPatternEditPart.VISUAL_ID == SDMVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<SDMNodeDescriptor> childDescriptors = SDMDiagramUpdater
				.getModifyingStoryNodeModifyingStoryNodeContentCompartment_7007SemanticChildren((View) getHost()
						.getModel());
