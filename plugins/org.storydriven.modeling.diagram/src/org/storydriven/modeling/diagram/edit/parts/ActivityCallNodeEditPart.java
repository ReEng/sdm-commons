...
import org.storydriven.modeling.diagram.edit.policies.ActivityCallNodeItemSemanticEditPolicy;
...
public class ActivityCallNodeEditPart extends ShapeNodeEditPart {
	...
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(110, 80);
		return result;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.storydriven.modeling.diagram.edit.parts.ActivityCallNodeEditPart) {
			types.add(SDMElementTypes.ActivityEdge_4001);
		}
