...
import org.storydriven.modeling.diagram.edit.commands.LinkVariableCreateCommand;
import org.storydriven.modeling.diagram.edit.commands.LinkVariableReorientCommand;
...
public class ObjectVariableItemSemanticEditPolicy extends
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (SDMVisualIDRegistry.getVisualID(incomingLink) == LinkVariableEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (SDMVisualIDRegistry.getVisualID(outgoingLink) == LinkVariableEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (SDMElementTypes.LinkVariable_4002 == req.getElementType()) {
