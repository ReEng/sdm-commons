...
public class StorydiagramsNavigatorLabelProvider extends LabelProvider
	...
	public Image getImage(View view) {
		...
		case ModifyingStoryNode2EditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://www..storydriven.org/storydiagrams/activities/0.1.0?ModifyingStoryNode", StorydiagramsElementTypes.ModifyingStoryNode_3007); //$NON-NLS-1$
		case StartNode2EditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://www..storydriven.org/storydiagrams/activities/0.1.0?StartNode", StorydiagramsElementTypes.StartNode_3003); //$NON-NLS-1$
		...
		case AttributeAssignmentEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://www..storydriven.org/storydiagrams/patterns/0.1.0?AttributeAssignment", StorydiagramsElementTypes.AttributeAssignment_3010); //$NON-NLS-1$
		...
		case StatementNode2EditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://www..storydriven.org/storydiagrams/activities/0.1.0?StatementNode", StorydiagramsElementTypes.StatementNode_3005); //$NON-NLS-1$
		case ActivityCallNodeEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://www..storydriven.org/storydiagrams/activities/0.1.0?ActivityCallNode", StorydiagramsElementTypes.ActivityCallNode_2007); //$NON-NLS-1$
		...
		case ModifyingStoryNodeEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://www..storydriven.org/storydiagrams/activities/0.1.0?ModifyingStoryNode", StorydiagramsElementTypes.ModifyingStoryNode_2006); //$NON-NLS-1$
		case ObjectVariableEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://www..storydriven.org/storydiagrams/patterns/0.1.0?ObjectVariable", StorydiagramsElementTypes.ObjectVariable_3009); //$NON-NLS-1$
		case PrimitiveVariableEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://www..storydriven.org/storydiagrams/patterns/0.1.0?PrimitiveVariable", StorydiagramsElementTypes.PrimitiveVariable_3011); //$NON-NLS-1$
		...
		case JunctionNode2EditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://www..storydriven.org/storydiagrams/activities/0.1.0?JunctionNode", StorydiagramsElementTypes.JunctionNode_3002); //$NON-NLS-1$
		case StructuredNode2EditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://www..storydriven.org/storydiagrams/activities/0.1.0?StructuredNode", StorydiagramsElementTypes.StructuredNode_3006); //$NON-NLS-1$
	...
	public String getText(View view) {
		...
		case ActivityCallNodeEditPart.VISUAL_ID:
			return getActivityCallNode_2007Text(view);
		case StopNodeEditPart.VISUAL_ID:
			return getStopNode_2002Text(view);
		case ModifyingStoryNodeEditPart.VISUAL_ID:
			return getModifyingStoryNode_2006Text(view);
		case ObjectVariableEditPart.VISUAL_ID:
	...
	private String getModifyingStoryNode_3007Text(View view) {
		IParser parser = StorydiagramsParserProvider.getParser(
				StorydiagramsElementTypes.ModifyingStoryNode_3007, view
	...
	private String getAttributeAssignment_3010Text(View view) {
		IParser parser = StorydiagramsParserProvider.getParser(
				StorydiagramsElementTypes.AttributeAssignment_3010, view
						.getElement() != null ? view.getElement() : view,
				StorydiagramsVisualIDRegistry
	...
	private String getTextualExpression_3001Text(View view) {
		IParser parser = StorydiagramsParserProvider.getParser(
				StorydiagramsElementTypes.TextualExpression_3001, view
						.getElement() != null ? view.getElement() : view,
				StorydiagramsVisualIDRegistry
	 ...
	 * @generated
	 */
	private String getActivityCallNode_2007Text(View view) {
		IParser parser = StorydiagramsParserProvider.getParser(
				StorydiagramsElementTypes.ActivityCallNode_2007, view
						.getElement() != null ? view.getElement() : view,
				StorydiagramsVisualIDRegistry
	 ...
	 * @generated
	 */
	private String getModifyingStoryNode_2006Text(View view) {
		IParser parser = StorydiagramsParserProvider.getParser(
				StorydiagramsElementTypes.ModifyingStoryNode_2006, view
						.getElement() != null ? view.getElement() : view,
				StorydiagramsVisualIDRegistry
	...
	private String getObjectVariable_3009Text(View view) {
		IParser parser = StorydiagramsParserProvider.getParser(
				StorydiagramsElementTypes.ObjectVariable_3009, view
						.getElement() != null ? view.getElement() : view,
				StorydiagramsVisualIDRegistry
	...
	private String getPrimitiveVariable_3011Text(View view) {
		IParser parser = StorydiagramsParserProvider.getParser(
				StorydiagramsElementTypes.PrimitiveVariable_3011, view
						.getElement() != null ? view.getElement() : view,
				StorydiagramsVisualIDRegistry
	...
	private String getStructuredNode_3006Text(View view) {
		IParser parser = StorydiagramsParserProvider.getParser(
				StorydiagramsElementTypes.StructuredNode_3006, view
						.getElement() != null ? view.getElement() : view,
				StorydiagramsVisualIDRegistry
