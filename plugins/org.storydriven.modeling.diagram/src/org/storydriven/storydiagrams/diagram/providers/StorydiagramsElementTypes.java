...
public class StorydiagramsElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType ModifyingStoryNode_2006 = getElementType("org.storydriven.storydiagrams.diagram.ModifyingStoryNode_2006"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType ActivityCallNode_2007 = getElementType("org.storydriven.storydiagrams.diagram.ActivityCallNode_2007"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(ModifyingStoryNode_2006,
					ActivitiesPackage.eINSTANCE.getModifyingStoryNode());

			elements.put(ActivityCallNode_2007,
					ActivitiesPackage.eINSTANCE.getActivityCallNode());

			elements.put(TextualExpression_3001,
					ExpressionsPackage.eINSTANCE.getTextualExpression());

			elements.put(JunctionNode_3002,
					ActivitiesPackage.eINSTANCE.getJunctionNode());

			elements.put(StartNode_3003,
					ActivitiesPackage.eINSTANCE.getStartNode());

			elements.put(StopNode_3004,
					ActivitiesPackage.eINSTANCE.getStopNode());

			elements.put(StatementNode_3005,
					ActivitiesPackage.eINSTANCE.getStatementNode());

			elements.put(StructuredNode_3006,
					ActivitiesPackage.eINSTANCE.getStructuredNode());

			elements.put(ModifyingStoryNode_3007,
					ActivitiesPackage.eINSTANCE.getModifyingStoryNode());
			...
			elements.put(AttributeAssignment_3010,
					PatternsPackage.eINSTANCE.getAttributeAssignment());

			elements.put(PrimitiveVariable_3011,
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(ModifyingStoryNode_2006);
			KNOWN_ELEMENT_TYPES.add(ActivityCallNode_2007);
	...
	public static IElementType getElementType(int visualID) {
		...
		case ModifyingStoryNodeEditPart.VISUAL_ID:
			return ModifyingStoryNode_2006;
		case ActivityCallNodeEditPart.VISUAL_ID:
			return ActivityCallNode_2007;
