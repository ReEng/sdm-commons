...
public class StructuredNodeStructuredNodeCompartmentItemSemanticEditPolicy
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (StorydiagramsElementTypes.StatementNode_3005 == req
				.getElementType()) {
			return getGEFWrapper(new StatementNode2CreateCommand(req));
		}
		if (StorydiagramsElementTypes.StructuredNode_3006 == req
				.getElementType()) {
			return getGEFWrapper(new StructuredNode2CreateCommand(req));
		}
		if (StorydiagramsElementTypes.ModifyingStoryNode_3007 == req
				.getElementType()) {
