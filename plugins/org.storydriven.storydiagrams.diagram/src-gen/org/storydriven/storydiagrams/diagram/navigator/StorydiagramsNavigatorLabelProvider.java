...
public class StorydiagramsNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider,
	...
	public Image getImage(View view) {
		...
		case MatchingStoryNode2EditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://www.storydriven.org/storydiagrams/activities/0.2.0?MatchingStoryNode", StorydiagramsElementTypes.MatchingStoryNode_3017); //$NON-NLS-1$
		...
		case ActivityCallNode2EditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://www.storydriven.org/storydiagrams/activities/0.2.0?ActivityCallNode", StorydiagramsElementTypes.ActivityCallNode_3016); //$NON-NLS-1$
		...
		case PathEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://www.storydriven.org/storydiagrams/patterns/0.2.0?Path", StorydiagramsElementTypes.Path_4003); //$NON-NLS-1$
	...
	public String getText(View view) {
		...
		case MatchingStoryNode2EditPart.VISUAL_ID:
			return getMatchingStoryNode_3017Text(view);
		case ActivityEdgeEditPart.VISUAL_ID:
		...
		case ActivityCallNode2EditPart.VISUAL_ID:
			return getActivityCallNode_3016Text(view);
		case StatementNodeEditPart.VISUAL_ID:
			return getStatementNode_2004Text(view);
		case PathEditPart.VISUAL_ID:
			return getPath_4003Text(view);
		case StartNodeEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	private String getMatchingStoryNode_3017Text(View view) {
		IParser parser = StorydiagramsParserProvider.getParser(StorydiagramsElementTypes.MatchingStoryNode_3017,
				view.getElement() != null ? view.getElement() : view,
	 ...
	 * @generated
	 */
	private String getPath_4003Text(View view) {
		Path domainModelElement = (Path) view.getElement();
		if (domainModelElement != null) {
			return domainModelElement.getName();
		} else {
			StorydiagramsDiagramEditorPlugin.getInstance().logError(
	 ...
	 * @generated
	 */
	private String getActivityCallNode_3016Text(View view) {
		IParser parser = StorydiagramsParserProvider.getParser(StorydiagramsElementTypes.ActivityCallNode_3016,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			StorydiagramsDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5027); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getStopNode_3004Text(View view) {
		IParser parser = StorydiagramsParserProvider.getParser(StorydiagramsElementTypes.StopNode_3004,
				view.getElement() != null ? view.getElement() : view,
				StorydiagramsVisualIDRegistry.getType(StopNodeSignatureLabelEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
			...
			StorydiagramsDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5024); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getStartNode_3003Text(View view) {
		IParser parser = StorydiagramsParserProvider.getParser(StorydiagramsElementTypes.StartNode_3003,
				view.getElement() != null ? view.getElement() : view,
				StorydiagramsVisualIDRegistry.getType(StartNodeSignatureLabelEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
			...
			StorydiagramsDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5022); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
