...
public class ModifyingStoryNodeStoryNodePatternCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getModifyingStoryNodeStoryNodePatternCompartment_7012SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getModifyingStoryNodeStoryNodePatternCompartment_7012SemanticChildren((View) getHost().getModel());
