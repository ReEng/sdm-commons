...
import org.storydriven.storydiagrams.diagram.edit.commands.ActivityCallNode2CreateCommand;
import org.storydriven.storydiagrams.diagram.edit.commands.JunctionNode2CreateCommand;
import org.storydriven.storydiagrams.diagram.edit.commands.MatchingStoryNode2CreateCommand;
 ...
 * @generated
 */
public class StructuredNodeStructuredNodeCompartmentItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (StorydiagramsElementTypes.ActivityCallNode_3016 == req.getElementType()) {
			return getGEFWrapper(new ActivityCallNode2CreateCommand(req));
		}
		...
		if (StorydiagramsElementTypes.MatchingStoryNode_3017 == req.getElementType()) {
