...
public class StatementNodeEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof StatementNodeNameEditPart) {
			((StatementNodeNameEditPart) childEditPart).setLabel(getPrimaryShape()
		...
		if (childEditPart instanceof StatementNodeStatementNodeCompartmentEditPart) {
			...
			pane.add(((StatementNodeStatementNodeCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof StatementNodeStatementNodeCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureStatementNodeFigureRectangleBody();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((StatementNodeStatementNodeCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
