...
public class StoryPatternStoryPatternContentCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getStoryPatternStoryPatternContentCompartment_7026SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getStoryPatternStoryPatternContentCompartment_7026SemanticChildren((View) getHost()
						.getModel());
