 ...
 * @generated
 */
public class StopNodeSignatureLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StopNodeSignatureLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StorydiagramsParserProvider
					.getParser(
							StorydiagramsElementTypes.StopNode_3004,
							getParserElement(),
							StorydiagramsVisualIDRegistry
									.getType(org.storydriven.storydiagrams.diagram.edit.parts.StopNodeSignatureLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
