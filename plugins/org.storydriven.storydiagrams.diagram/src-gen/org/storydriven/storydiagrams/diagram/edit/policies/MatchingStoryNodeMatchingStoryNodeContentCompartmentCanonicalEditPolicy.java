 ...
 * @generated
 */
public class MatchingStoryNodeMatchingStoryNodeContentCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getMatchingStoryNodeMatchingStoryNodeContentCompartment_7015SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getMatchingStoryNodeMatchingStoryNodeContentCompartment_7015SemanticChildren((View) getHost()
						.getModel());
