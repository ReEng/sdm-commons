 ...
 * @generated
 */
public class InitialNodeEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	static {
		registerSnapBackPosition(
				StorydiagramsVisualIDRegistry
						.getType(org.storydriven.storydiagrams.diagram.edit.parts.InitialNodeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StorydiagramsParserProvider.getParser(StorydiagramsElementTypes.StartNode_2001,
