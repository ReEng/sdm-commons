 ...
 * @generated
 */
public class StatementNodeStatementNodeCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getStatementNodeStatementNodeCompartment_7017SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return TextualExpressionEditPart.VISUAL_ID == StorydiagramsVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getStatementNodeStatementNodeCompartment_7017SemanticChildren((View) getHost()
						.getModel());
