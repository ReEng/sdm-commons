...
import org.storydriven.storydiagrams.diagram.edit.policies.JunctionNode2ItemSemanticEditPolicy;
...
public class JunctionNode2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new JunctionNode2ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.storydriven.storydiagrams.diagram.edit.parts.JunctionNode2EditPart) {
			types.add(StorydiagramsElementTypes.ActivityEdge_4001);
		}
