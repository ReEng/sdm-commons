...
public class ModifyingStoryNodeModifyingStoryNodeContentCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getModifyingStoryNodeModifyingStoryNodeContentCompartment_7013SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getModifyingStoryNodeModifyingStoryNodeContentCompartment_7013SemanticChildren((View) getHost()
						.getModel());
