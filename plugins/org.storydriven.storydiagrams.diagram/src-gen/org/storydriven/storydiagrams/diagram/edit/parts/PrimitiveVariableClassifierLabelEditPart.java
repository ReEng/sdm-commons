 ...
 * @generated
 */
public class PrimitiveVariableClassifierLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof StorydiagramsTextSelectionEditPolicy) {
			((StorydiagramsTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof StorydiagramsTextSelectionEditPolicy) {
			((StorydiagramsTextSelectionEditPolicy) sfEditPolicy).refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StorydiagramsParserProvider
					.getParser(
							StorydiagramsElementTypes.PrimitiveVariable_3011,
							getParserElement(),
							StorydiagramsVisualIDRegistry
									.getType(org.storydriven.storydiagrams.diagram.edit.parts.PrimitiveVariableClassifierLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
