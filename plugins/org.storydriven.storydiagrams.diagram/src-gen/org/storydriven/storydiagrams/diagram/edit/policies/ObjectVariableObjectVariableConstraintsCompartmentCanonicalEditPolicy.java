...
public class ObjectVariableObjectVariableConstraintsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getObjectVariableObjectVariableConstraintsCompartment_7008SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getObjectVariableObjectVariableConstraintsCompartment_7008SemanticChildren((View) getHost().getModel());
