...
public class MatchingPatternStoryPatternContentCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getMatchingPatternStoryPatternContentCompartment_7033SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == ObjectVariableEditPart.VISUAL_ID
				|| visualID == CollectionVariableEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getMatchingPatternStoryPatternContentCompartment_7033SemanticChildren((View) getHost()
						.getModel());
