...
public class MatchingPatternStoryPatternContentCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getMatchingPatternStoryPatternContentCompartment_7020SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == ObjectVariableEditPart.VISUAL_ID || visualID == ObjectSetVariableEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getMatchingPatternStoryPatternContentCompartment_7020SemanticChildren((View) getHost().getModel());
