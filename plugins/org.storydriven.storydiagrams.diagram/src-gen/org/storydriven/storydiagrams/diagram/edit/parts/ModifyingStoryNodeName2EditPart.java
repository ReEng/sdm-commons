 ...
 * @generated
 */
public class ModifyingStoryNodeName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StorydiagramsParserProvider
					.getParser(
							StorydiagramsElementTypes.ModifyingStoryNode_3007,
							getParserElement(),
							StorydiagramsVisualIDRegistry
									.getType(org.storydriven.storydiagrams.diagram.edit.parts.ModifyingStoryNodeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
