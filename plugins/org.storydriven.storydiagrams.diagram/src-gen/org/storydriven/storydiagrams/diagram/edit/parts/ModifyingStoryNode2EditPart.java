...
import org.storydriven.storydiagrams.diagram.edit.policies.ModifyingStoryNode2ItemSemanticEditPolicy;
...
public class ModifyingStoryNode2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ModifyingStoryNode2ItemSemanticEditPolicy());
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(StorydiagramsVisualIDRegistry.getType(ModifyingStoryNodeName2EditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof org.storydriven.storydiagrams.diagram.edit.parts.ModifyingStoryNode2EditPart) {
			types.add(StorydiagramsElementTypes.ActivityEdge_4001);
		}
