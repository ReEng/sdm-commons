...
public class StoryPatternStoryPatternConstraintsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getStoryPatternStoryPatternConstraintsCompartment_7024SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getStoryPatternStoryPatternConstraintsCompartment_7024SemanticChildren((View) getHost().getModel());
