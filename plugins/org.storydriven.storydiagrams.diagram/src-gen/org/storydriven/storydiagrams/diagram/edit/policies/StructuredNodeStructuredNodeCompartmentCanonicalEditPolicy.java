 ...
 * @generated
 */
public class StructuredNodeStructuredNodeCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected void refreshSemantic() {
		...
		List<StorydiagramsNodeDescriptor> childDescriptors = StorydiagramsDiagramUpdater
				.getStructuredNodeStructuredNodeCompartment_7002SemanticChildren((View) getHost().getModel());
