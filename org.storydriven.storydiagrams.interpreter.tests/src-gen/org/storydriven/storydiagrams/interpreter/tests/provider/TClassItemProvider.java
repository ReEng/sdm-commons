...
/**
 * This is the item provider adapter for a {@link org.storydriven.storydiagrams.interpreter.tests.TClass} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class TClassItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public TClassItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addExtendedClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_TClass_extendedClass_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_TClass_extendedClass_feature", "_UI_TClass_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				TestsPackage.Literals.TCLASS__EXTENDED_CLASS, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((TClass) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_TClass_type") : //$NON-NLS-1$
				getString("_UI_TClass_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TClass.class)) {
