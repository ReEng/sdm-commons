...
/**
 * This is the item provider adapter for a {@link org.storydriven.storydiagrams.interpreter.tests.TModel} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class TModelItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public TModelItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TestsPackage.Literals.TMODEL__PACKAGES);
		}
	...
	public String getText(Object object) {
		String label = ((TModel) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_TModel_type") : //$NON-NLS-1$
				getString("_UI_TModel_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TModel.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(TestsPackage.Literals.TMODEL__PACKAGES,
