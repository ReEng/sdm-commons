 ...
 * @generated
 */
public class SDMDiagramEditorPlugin extends AbstractUIPlugin {

	/**
	 * @generated
	 */
	public static final String ID = "org.storydriven.modeling.diagram"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private static SDMDiagramEditorPlugin instance;
	 ...
	 * @generated
	 */
	private SDMDocumentProvider documentProvider;

	/**
	 * @generated
	 */
	private SDMBaseItemSemanticEditPolicy.LinkConstraints linkConstraints;
	 ...
	 * @generated
	 */
	public static SDMDiagramEditorPlugin getInstance() {
		return instance;
	}
	 ...
	 * @generated
	 */
	public SDMDocumentProvider getDocumentProvider() {
		if (documentProvider == null) {
			documentProvider = new SDMDocumentProvider();
		}
	 ...
	 * @generated
	 */
	public SDMBaseItemSemanticEditPolicy.LinkConstraints getLinkConstraints() {
	...
	public void setLinkConstraints(
			SDMBaseItemSemanticEditPolicy.LinkConstraints lc) {
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, SDMDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, SDMDiagramEditorPlugin.ID, IStatus.OK,
						message, throwable));
