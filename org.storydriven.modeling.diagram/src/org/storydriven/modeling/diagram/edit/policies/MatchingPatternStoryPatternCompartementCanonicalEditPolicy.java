 ...
 * @generated
 */
public class MatchingPatternStoryPatternCompartementCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<SDMNodeDescriptor> childDescriptors = SDMDiagramUpdater
				.getMatchingPatternStoryPatternCompartement_7005SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ObjectVariableEditPart.VISUAL_ID == SDMVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<SDMNodeDescriptor> childDescriptors = SDMDiagramUpdater
				.getMatchingPatternStoryPatternCompartement_7005SemanticChildren((View) getHost()
						.getModel());
