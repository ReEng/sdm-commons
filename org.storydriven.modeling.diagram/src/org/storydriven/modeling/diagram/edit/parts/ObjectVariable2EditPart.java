...
import org.storydriven.modeling.diagram.edit.policies.ObjectVariable2ItemSemanticEditPolicy;
import org.storydriven.modeling.diagram.part.SDMVisualIDRegistry;

/**
 * @generated
 */
public class ObjectVariable2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ObjectVariable2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ObjectVariable2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ObjectVariableName2EditPart) {
			((ObjectVariableName2EditPart) childEditPart)
