...
import org.storydriven.modeling.diagram.edit.policies.MatchingStoryNode2ItemSemanticEditPolicy;
...
public class MatchingStoryNode2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MatchingStoryNode2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MatchingStoryNodeName2EditPart) {
			((MatchingStoryNodeName2EditPart) childEditPart)
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.storydriven.modeling.diagram.edit.parts.MatchingStoryNode2EditPart) {
			types.add(SDMElementTypes.ActivityEdge_4001);
		}
