...
import org.storydriven.modeling.diagram.edit.policies.JunctionNodeItemSemanticEditPolicy;
...
public class JunctionNodeEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.storydriven.modeling.diagram.edit.parts.JunctionNodeEditPart) {
			types.add(SDMElementTypes.ActivityEdge_4001);
		}
