...
import org.storydriven.modeling.diagram.edit.policies.StartNode2ItemSemanticEditPolicy;
...
public class StartNode2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new StartNode2ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.storydriven.modeling.diagram.edit.parts.StartNode2EditPart) {
			types.add(SDMElementTypes.ActivityEdge_4001);
		}
