package de.fujaba.commons.handlers;
...
import de.fujaba.commons.edit.parts.AbstractDiagramEditPart;
import de.fujaba.commons.edit.parts.AbstractNodeEditPart;
...
public class ResizeHandler extends AbstractHandler
{
   ...
   private static final String TO_MINIMUM = "de.fujaba.commons.editor.resize.minimum"; //$NON-NLS-1$

   private static final String USE_COMMAND_STACK = "de.fujaba.commons.editor.resize.commandstack"; //$NON-NLS-1$
