 ...
 * <ul>
 *   <li>{@link de.fujaba.commons.notation.RelativeBendPoint#getSourceX <em>Source X</em>}</li>
 *   <li>{@link de.fujaba.commons.notation.RelativeBendPoint#getSourceY <em>Source Y</em>}</li>
 *   <li>{@link de.fujaba.commons.notation.RelativeBendPoint#getTargetX <em>Target X</em>}</li>
 *   <li>{@link de.fujaba.commons.notation.RelativeBendPoint#getTargetY <em>Target Y</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.fujaba.commons.notation.NotationPackage#getRelativeBendPoint()
 * @model
 * @generated
 */
public interface RelativeBendPoint extends BendPoint
{
    ...
    * @see #setSourceX(int)
    * @see de.fujaba.commons.notation.NotationPackage#getRelativeBendPoint_SourceX()
   ...
   /**
    * Sets the value of the '{@link de.fujaba.commons.notation.RelativeBendPoint#getSourceX <em>Source X</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * @see #setSourceY(int)
    * @see de.fujaba.commons.notation.NotationPackage#getRelativeBendPoint_SourceY()
    * @model unique="false" required="true" ordered="false"
    * @generated
    */
   int getSourceY();
   ...
   /**
    * Sets the value of the '{@link de.fujaba.commons.notation.RelativeBendPoint#getSourceY <em>Source Y</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * @see #setTargetX(int)
    * @see de.fujaba.commons.notation.NotationPackage#getRelativeBendPoint_TargetX()
    * @model unique="false" required="true" ordered="false"
    * @generated
    */
   int getTargetX();
   ...
   /**
    * Sets the value of the '{@link de.fujaba.commons.notation.RelativeBendPoint#getTargetX <em>Target X</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * @see #setTargetY(int)
    * @see de.fujaba.commons.notation.NotationPackage#getRelativeBendPoint_TargetY()
    * @model unique="false" required="true" ordered="false"
    * @generated
    */
   int getTargetY();
   ...
   /**
    * Sets the value of the '{@link de.fujaba.commons.notation.RelativeBendPoint#getTargetY <em>Target Y</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
