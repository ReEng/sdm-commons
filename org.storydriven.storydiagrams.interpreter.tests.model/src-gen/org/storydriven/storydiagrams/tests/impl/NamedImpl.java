 ...
 * <ul>
 *   <li>{@link org.storydriven.storydiagrams.tests.impl.NamedImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class NamedImpl extends MinimalEObjectImpl.Container implements Named {
	...
	protected EClass eStaticClass() {
		return TestsPackage.Literals.NAMED;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestsPackage.NAMED__NAME, oldName, name));
	}
