...
public class SDMSwitch<T>
{
   ...
   protected T doSwitch (int classifierID, EObject theEObject)
   {
      switch (classifierID)
      {
         ...
         case SDMPackage.STRING_EXPRESSION:
         {
            ...
            if (result == null)
            {
               result = caseExtendableElement(stringExpression);
            }
            if (result == null)
            {
               result = defaultCase(theEObject);
   ...
   /**
    * Returns the result of interpreting the object as an instance of '<em>String Expression</em>'. <!-- begin-user-doc --> This implementation returns null; returning a non-null
    * result will terminate the switch. <!-- end-user-doc -->
    * 
    * @param object the target of the switch.
