...
public class ActivitiesAdapterFactory extends AdapterFactoryImpl
{
   ...
   protected ActivitiesSwitch<Adapter> modelSwitch = new ActivitiesSwitch<Adapter>()
   {
      ...
      @Override
      public Adapter caseExceptionExpression (ExceptionExpression object)
      {
         return createExceptionExpressionAdapter();
      }
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.storydriven.modeling.activities.DecisionNode <em>Decision Node</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.storydriven.modeling.activities.ExceptionExpression <em>Exception Expression</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
    ...
    * @generated
    */
   public Adapter createExceptionExpressionAdapter ()
   {
      return null;
   }
