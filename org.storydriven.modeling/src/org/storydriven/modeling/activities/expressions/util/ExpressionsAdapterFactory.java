 ...
 * $Id$
 */
package org.storydriven.modeling.activities.expressions.util;
...
public class ExpressionsAdapterFactory extends AdapterFactoryImpl
{
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.storydriven.modeling.activities.expressions.ExceptionVariableExpression <em>Exception Variable Expression</em>}'.
    * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases
    * anyway. <!-- end-user-doc -->
