...
public class OperationExtensionImpl extends ExtensionImpl implements OperationExtension
{
   ...
   public EList<EParameter> getOutParameters ()
   {
      ...
      parameter.setEGenericType(EcoreUtil.copy(operation.getEGenericType()));

      /*
       * FIXME that parameter is not contained anywhere. This might cause problems with code that assumes proper containment of all EObjects in Resources.
       */
      return new BasicEList.UnmodifiableEList<EParameter>(1, new EParameter[] {parameter});
   }
