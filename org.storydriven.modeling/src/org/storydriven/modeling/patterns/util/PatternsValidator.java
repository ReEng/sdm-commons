...
public class PatternsValidator extends EObjectValidator
{
   ...
   protected boolean validate (int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context)
   {
      switch (classifierID)
      {
         ...
         case PatternsPackage.LINK_ORDER_CONSTRAINT:
            return validateLinkOrderConstraint((LinkOrderConstraint) value, diagnostics, context);
    ...
    * @generated
    */
   public boolean validateLinkOrderConstraint (LinkOrderConstraint linkOrderConstraint, DiagnosticChain diagnostics,
                                               Map<Object, Object> context)
   {
      return validate_EveryDefaultConstraint(linkOrderConstraint, diagnostics, context);
   }
    ...
    * @generated
    */
   public boolean validateOrderConstraintType (OrderConstraintType orderConstraintType, DiagnosticChain diagnostics,
                                               Map<Object, Object> context)
   {
      return true;
   }
