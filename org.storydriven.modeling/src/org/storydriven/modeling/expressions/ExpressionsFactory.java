...
public interface ExpressionsFactory extends EFactory
{
   ...
   /**
    * Returns a new object of class '<em>Collaboration</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns a new object of class '<em>Complex Expression</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns a new object of class '<em>For Loop</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns a new object of class '<em>While Loop</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns a new object of class '<em>Conditional Expression</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
