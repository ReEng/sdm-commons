...
public class ExpressionsSwitch<T>
{
   ...
   /**
    * Returns the result of interpreting the object as an instance of '<em>Method Call Expression</em>'. <!-- begin-user-doc --> This implementation returns null; returning a
   ...
   /**
    * Returns the result of interpreting the object as an instance of '<em>Parameter Expression</em>'. <!-- begin-user-doc --> This implementation returns null; returning a
    * non-null result will terminate the switch. <!-- end-user-doc -->
    * 
    * @param object the target of the switch.
