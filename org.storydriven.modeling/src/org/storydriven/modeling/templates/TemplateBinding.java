...
{
   /**
    * Returns the value of the '<em><b>Bound Parameter</b></em>' reference. <!-- begin-user-doc -->
    * <p>
   ...
   /**
    * Sets the value of the '{@link org.storydriven.modeling.templates.TemplateBinding#getBoundParameter <em>Bound Parameter</em>}' reference. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.storydriven.modeling.templates.TemplateBinding#getBindingExpression <em>Binding Expression</em>}' containment reference. <!-- begin-user-doc
    * --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Property Binding</b></em>' containment reference list. The list contents are of type
    * {@link org.storydriven.modeling.templates.PropertyBinding}. It is bidirectional and its opposite is '
    * {@link org.storydriven.modeling.templates.PropertyBinding#getTemplateBinding <em>Template Binding</em>}'. <!-- begin-user-doc -->
    * <p>
   ...
   /**
    * Returns the value of the '<em><b>Template</b></em>' container reference. It is bidirectional and its opposite is '
    * {@link org.storydriven.modeling.templates.ObjectPatternTemplate#getTemplateBindings <em>Template Binding</em>}'. <!-- begin-user-doc -->
    * <p>
    ...
    * @see #setTemplate(ObjectPatternTemplate)
    ...
    * @generated
    */
   ObjectPatternTemplate getTemplate ();

   /**
    * Sets the value of the '{@link org.storydriven.modeling.templates.TemplateBinding#getTemplate <em>Template</em>}' container reference. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
    ...
    * @generated
    */
   void setTemplate (ObjectPatternTemplate value);
