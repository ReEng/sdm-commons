...
public class TemplatesPackageImpl extends EPackageImpl implements TemplatesPackage
{
    ...
    * <p>
    * This method is used to initialize {@link TemplatesPackage#eINSTANCE} when that field is accessed. Clients should not invoke it directly. Instead, they should simply access
   ...
   {
      return this.objectPatternTemplateEClass;
   }
   ...
   {
      return (EReference) this.objectPatternTemplateEClass.getEStructuralFeatures().get(0);
   }
   ...
   {
      return (EReference) this.objectPatternTemplateEClass.getEStructuralFeatures().get(1);
   }
   ...
   public void createPackageContents ()
   {
      ...
      this.objectPatternTemplateEClass = createEClass(OBJECT_PATTERN_TEMPLATE);
      createEReference(this.objectPatternTemplateEClass, OBJECT_PATTERN_TEMPLATE__TYPE_PARAMETER);
      createEReference(this.objectPatternTemplateEClass, OBJECT_PATTERN_TEMPLATE__TEMPLATE_BINDING);

      this.templateBindingEClass = createEClass(TEMPLATE_BINDING);
      createEReference(this.templateBindingEClass, TEMPLATE_BINDING__BOUND_PARAMETER);
      createEReference(this.templateBindingEClass, TEMPLATE_BINDING__BINDING_EXPRESSION);
      createEReference(this.templateBindingEClass, TEMPLATE_BINDING__PROPERTY_BINDING);
      createEReference(this.templateBindingEClass, TEMPLATE_BINDING__TEMPLATE);

      this.propertyBindingEClass = createEClass(PROPERTY_BINDING);
      createEReference(this.propertyBindingEClass, PROPERTY_BINDING__BOUND_PROPERTY);
      createEReference(this.propertyBindingEClass, PROPERTY_BINDING__BINDING_EXPRESSION);
      createEReference(this.propertyBindingEClass, PROPERTY_BINDING__TEMPLATE_BINDING);
   }
   ...
   public void initializePackageContents ()
   {
      ...
      this.objectPatternTemplateEClass.getESuperTypes().add(thePatternPackage.getObjectPattern());
      this.templateBindingEClass.getESuperTypes().add(theSDMPackage.getExtendableElement());
      this.propertyBindingEClass.getESuperTypes().add(theSDMPackage.getExtendableElement());

      // Initialize classes and features; add operations and parameters
      initEClass(this.objectPatternTemplateEClass, ObjectPatternTemplate.class, "ObjectPatternTemplate", !IS_ABSTRACT,
      ...
      initEReference(getObjectPatternTemplate_TemplateBinding(), getTemplateBinding(), getTemplateBinding_Template(),
         "templateBinding", null, 0, -1, ObjectPatternTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
         IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

      initEClass(this.templateBindingEClass, TemplateBinding.class, "TemplateBinding", !IS_ABSTRACT, !IS_INTERFACE,
      ...
      initEReference(getTemplateBinding_BindingExpression(), theSDMPackage.getExpression(), null, "bindingExpression",
         null, 1, 1, TemplateBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
         IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      initEReference(getTemplateBinding_PropertyBinding(), getPropertyBinding(), getPropertyBinding_TemplateBinding(),
         "propertyBinding", null, 0, -1, TemplateBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
         IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      initEReference(getTemplateBinding_Template(), getObjectPatternTemplate(),
         getObjectPatternTemplate_TemplateBinding(), "template", null, 1, 1, TemplateBinding.class, !IS_TRANSIENT,
         !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
         !IS_ORDERED);

      initEClass(this.propertyBindingEClass, PropertyBinding.class, "PropertyBinding", !IS_ABSTRACT, !IS_INTERFACE,
         IS_GENERATED_INSTANCE_CLASS);
      ...
      initEReference(getPropertyBinding_BindingExpression(), theSDMPackage.getExpression(), null, "bindingExpression",
         ...
         IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      initEReference(getPropertyBinding_TemplateBinding(), getTemplateBinding(), getTemplateBinding_PropertyBinding(),
         "templateBinding", null, 1, 1, PropertyBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
         !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
   }
