...
public interface TemplatesFactory extends EFactory
{
   ...
   /**
    * Returns a new object of class '<em>Object Pattern Template</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
    * @return a new object of class '<em>Object Pattern Template</em>'.
    * @generated
    */
   ObjectPatternTemplate createObjectPatternTemplate ();

   /**
    * Returns a new object of class '<em>Template Binding</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns a new object of class '<em>Property Binding</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
