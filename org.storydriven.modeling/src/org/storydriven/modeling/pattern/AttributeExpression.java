...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Attribute Expression</b></em>'. <!-- end-user-doc -->
 * <p>
...
{
   /**
    * Returns the value of the '<em><b>Operator</b></em>' attribute. The default value is <code>"EQUAL"</code>. The literals are from the enumeration
    * {@link org.storydriven.modeling.pattern.Operator}. <!-- begin-user-doc -->
    * <p>
   ...
   /**
    * Sets the value of the '{@link org.storydriven.modeling.pattern.AttributeExpression#getOperator <em>Operator</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Owning Object</b></em>' container reference. It is bidirectional and its opposite is '
    * {@link org.storydriven.modeling.pattern.Object#getOwnedAttributeExpressions <em>Owned Attribute Expression</em>}'. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Owning Object</em>' container reference isn't clear, there really should be more of a description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.storydriven.modeling.pattern.AttributeExpression#getOwningObject <em>Owning Object</em>}' container reference. <!-- begin-user-doc --> <!--
    * end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.storydriven.modeling.pattern.AttributeExpression#getAttribute <em>Attribute</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Value</b></em>' containment reference list. The list contents are of type {@link org.storydriven.modeling.Expression}. <!-- begin-user-doc
    * -->
    * <p>
    * If the meaning of the '<em>Value</em>' containment reference list isn't clear, there really should be more of a description here...
    * </p>
    * <!-- end-user-doc -->
    * 
