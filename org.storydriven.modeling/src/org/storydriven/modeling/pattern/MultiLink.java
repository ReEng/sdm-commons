...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Multi Link</b></em>'. <!-- end-user-doc -->
 * <p>
...
public interface MultiLink extends ExtendableElement
{
   ...
   /**
    * Sets the value of the '{@link org.storydriven.modeling.pattern.MultiLink#getIndex <em>Index</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Multi Link Type</b></em>' attribute. The default value is <code>"DIRECT"</code>. The literals are from the enumeration
    * {@link org.storydriven.modeling.pattern.MultiLinkType}. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Multi Link Type</em>' attribute isn't clear, there really should be more of a description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.storydriven.modeling.pattern.MultiLink#getMultiLinkType <em>Multi Link Type</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Negative</b></em>' attribute. <!-- begin-user-doc -->
    * <p>
   ...
   /**
    * Sets the value of the '{@link org.storydriven.modeling.pattern.MultiLink#isNegative <em>Negative</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Source Link</b></em>' container reference. It is bidirectional and its opposite is '
    * {@link org.storydriven.modeling.pattern.Link#getMultiLinkFromSources <em>Multi Link From Source</em>}'. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Source Link</em>' container reference isn't clear, there really should be more of a description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.storydriven.modeling.pattern.MultiLink#getSourceLink <em>Source Link</em>}' container reference. <!-- begin-user-doc --> <!-- end-user-doc
    * -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Target Object</b></em>' reference. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Target Object</em>' reference isn't clear, there really should be more of a description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.storydriven.modeling.pattern.MultiLink#getTargetObject <em>Target Object</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns the value of the '<em><b>Target Link</b></em>' reference. It is bidirectional and its opposite is '{@link org.storydriven.modeling.pattern.Link#getMultiLinkToTargets
    * <em>Multi Link To Target</em>}'. <!-- begin-user-doc -->
    * <p>
    * If the meaning of the '<em>Target Link</em>' reference isn't clear, there really should be more of a description here...
    * </p>
    * <!-- end-user-doc -->
    * 
   ...
   /**
    * Sets the value of the '{@link org.storydriven.modeling.pattern.MultiLink#getTargetLink <em>Target Link</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
