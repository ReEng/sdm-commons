...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Attribute Expression</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class AttributeExpressionImpl extends NamedElementImpl implements AttributeExpression
{
   ...
   /**
    * The cached value of the '{@link #getValues() <em>Value</em>}' containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
    * @see #getValues()
    * @generated
    * @ordered
   ...
   public EAttribute getAttribute ()
   {
      if (this.attribute != null && this.attribute.eIsProxy())
      {
         ...
         this.attribute = (EAttribute) eResolveProxy(oldAttribute);
         if (this.attribute != oldAttribute)
         {
            if (eNotificationRequired())
            {
               eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                  PatternPackage.ATTRIBUTE_EXPRESSION__ATTRIBUTE, oldAttribute, this.attribute));
            }
         }
      }
   ...
   public EList<Expression> getValues ()
   {
      if (this.values == null)
      {
         this.values = new EObjectContainmentEList.Resolving<Expression>(Expression.class, this,
