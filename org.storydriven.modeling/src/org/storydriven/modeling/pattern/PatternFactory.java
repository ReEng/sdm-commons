...
public interface PatternFactory extends EFactory
{
   ...
   /**
    * Returns a new object of class '<em>Attribute Expression</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns a new object of class '<em>Multi Link</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns a new object of class '<em>Object Pattern</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns a new object of class '<em>Story Node</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
   ...
   /**
    * Returns a new object of class '<em>Object</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
