...
public class GenericStoryPatternConverter<theType, targetType> extends SdmConverter {
	
	public GenericStoryPatternConverter(theType aSourcePattern, DiagramEditPart diagramEP, EditPart targetParentEP) {
		super(diagramEP, targetParentEP);
		sourcePattern = aSourcePattern;
	}

	private theType					sourcePattern = null;
	private	StoryPattern			targetPattern = null;
	private	View 					targetPatternView = null;
	
	public StoryPattern convert(theType aSourcePattern) {
		sourcePattern = aSourcePattern;
