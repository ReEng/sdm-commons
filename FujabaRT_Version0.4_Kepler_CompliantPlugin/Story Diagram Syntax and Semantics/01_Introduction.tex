...
Furthermore, \fe{maybe links} can now be used to circumvent the isomorphic matching for certain object variables (\ref{sec:StoryPatterns:specialLinks:maybeLink}).
