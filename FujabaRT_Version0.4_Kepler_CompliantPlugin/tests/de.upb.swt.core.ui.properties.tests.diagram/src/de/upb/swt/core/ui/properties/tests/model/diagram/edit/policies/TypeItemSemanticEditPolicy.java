...
import de.upb.swt.core.ui.properties.tests.model.diagram.edit.commands.BooleanAttributeCreateCommand;
import de.upb.swt.core.ui.properties.tests.model.diagram.edit.commands.ReferenceCreateCommand;
import de.upb.swt.core.ui.properties.tests.model.diagram.edit.commands.ReferenceReorientCommand;
...
public class TypeItemSemanticEditPolicy extends ModelBaseItemSemanticEditPolicy {
	...
	public TypeItemSemanticEditPolicy() {
		super(ModelElementTypes.Type_2001);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (ModelElementTypes.BooleanAttribute_3001 == req.getElementType()) {
			return getGEFWrapper(new BooleanAttributeCreateCommand(req));
		}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ModelVisualIDRegistry.getVisualID(incomingLink) == ReferenceEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ModelVisualIDRegistry.getVisualID(outgoingLink) == ReferenceEditPart.VISUAL_ID) {
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (ModelElementTypes.Reference_4001 == req.getElementType()) {
