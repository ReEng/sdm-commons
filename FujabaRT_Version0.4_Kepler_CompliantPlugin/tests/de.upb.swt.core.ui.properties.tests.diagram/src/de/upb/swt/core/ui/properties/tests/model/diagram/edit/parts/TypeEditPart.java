...
import de.upb.swt.core.ui.properties.tests.model.diagram.edit.policies.TypeCanonicalEditPolicy;
import de.upb.swt.core.ui.properties.tests.model.diagram.edit.policies.TypeItemSemanticEditPolicy;
...
public class TypeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new TypeCanonicalEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSource() {
		...
		types.add(ModelElementTypes.Reference_4001);
		return types;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof de.upb.swt.core.ui.properties.tests.model.diagram.edit.parts.TypeEditPart) {
			types.add(ModelElementTypes.Reference_4001);
		}
		return types;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == ModelElementTypes.Reference_4001) {
