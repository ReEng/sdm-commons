...
/**
 * This is the item provider adapter for a {@link org.storydriven.storydiagrams.tests.Field} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FieldItemProvider extends MemberItemProvider implements IEditingDomainItemProvider,
	...
	protected void addContainerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Field_container_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Field_container_feature", "_UI_Field_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				TestsPackage.Literals.FIELD__CONTAINER, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TestsPackage.Literals.FIELD__STATEMENT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case TestsPackage.FIELD__STATEMENT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(TestsPackage.Literals.FIELD__STATEMENT,
				TestsFactory.eINSTANCE.createStatement()));
	}
