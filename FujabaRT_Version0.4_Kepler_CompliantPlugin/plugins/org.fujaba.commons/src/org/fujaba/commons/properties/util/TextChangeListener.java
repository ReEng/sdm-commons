...
/**
 * TextChangeListener notifies the listener of text lifecycle events on behalf of the widget(s) it
 * listens to.
 */
public abstract class TextChangeListener implements Listener
{
   ...
   /**
    * Marks the start of a programmatic change to the widget contents. Clients must call
    * startNonUserChange() before directly setting the widget contents to avoid unwanted lifecycle
    * events.
    * 
   ...
   /**
    * Clients who call startNonUserChange() should call finishNonUserChange() as soon as possible
   ...
   /**
    * This method is method notified when the focus is gained Client may override this method if he
    * desire some particular behavior
    * 
    * @param control the given control.
    */
   ...
   /**
    * This method is notified when the focus is lost Client may override this method if he desire
   ...
   /**
    * This method is notified when text is been modified Client may override this method if he
    * desire some particular behavior
    * 
    * @param control the given control.
    */
   ...
   /**
    * Registers this helper with the given control to listen for events which indicate that a change
   ...
   /**
    * Registers this helper with the given control to listen for the Enter key. When Enter is
    * pressed, the change is considered done (this is only appropriate for single-line Text
    * widgets).
    * 
    * @param control the given control.
    */
   ...
   /**
    * Unregisters this helper from a control previously passed to startListeningTo() and/or
