...
public class TemplateBindingPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, TemplateBindingPropertiesEditionPart {
	...
	protected Composite createBoundParameterFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(TemplatesViewsRepository.TemplateBinding.Properties.boundParameter, TemplatesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createTemplateFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(TemplatesViewsRepository.TemplateBinding.Properties.template, TemplatesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
