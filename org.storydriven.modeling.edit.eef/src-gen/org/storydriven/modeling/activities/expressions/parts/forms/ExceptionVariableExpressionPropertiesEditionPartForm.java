 ...
 */
package org.storydriven.modeling.activities.expressions.parts.forms;
...
public class ExceptionVariableExpressionPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ExceptionVariableExpressionPropertiesEditionPart {
	...
	protected Composite createCommentText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ExpressionsViewsRepository.ExceptionVariableExpression.Properties.comment, ExpressionsViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createExceptionVariableFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ExpressionsViewsRepository.ExceptionVariableExpression.Properties.exceptionVariable, ExpressionsViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
