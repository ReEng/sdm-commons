...
public class ExceptionVariablePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ExceptionVariablePropertiesEditionPart {
	...
	protected Composite createActivityEdgeFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.ExceptionVariable.Properties.activityEdge, ActivitiesViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createNameText(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.ExceptionVariable.Properties.name, ActivitiesViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
