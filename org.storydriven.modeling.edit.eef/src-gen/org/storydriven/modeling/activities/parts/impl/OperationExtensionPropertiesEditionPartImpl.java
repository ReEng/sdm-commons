...
public class OperationExtensionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, OperationExtensionPropertiesEditionPart {
	...
	protected Composite createExtendableBaseFlatComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.OperationExtension.Properties.extendableBase, ActivitiesViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createCommentText(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ActivitiesViewsRepository.OperationExtension.Properties.comment, ActivitiesViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
